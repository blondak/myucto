...
$navod = implode("\n", [
    ...
    '',
    'OBNOVA',
    '  Rozbalte obsah archivu do korene instalace (stejne jako zalohy documents',
    '  a pdf). Cesty uvnitr uz zacinaji storage/ a odpovidaji cilovemu rozlozeni,',
    '  nic se neprejmenovava.',
    '',
    'DULEZITE',
