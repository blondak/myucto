 ...
 * karty): účty úroků, poplatků, splátek, výběrů, odměn a počátečního dluhu. Změna platí
 * jen pro budoucí zápisy - zaúčtované pohyby se nepřeúčtovávají.
 */
final class CreditCardSettingsService
{
    ...
    {
        return CreditCardSettingsRepository::DEFAULT_CODES;
    }
