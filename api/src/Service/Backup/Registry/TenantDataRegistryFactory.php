...
use MyInvoice\Service\Backup\Company\CompanyBackupCashDocumentVatLinesProjection;
...
use MyInvoice\Service\Backup\Company\CompanyBackupPayrollRunEmploymentsProjection;
...
final class TenantDataRegistryFactory
{
    ...
    private static function companyBackupProjection(string $table): array
    {
        ...
        if ($table === 'payroll_run_employments') {
            return [
                'company_backup' => [
                    'data_columns' =>
                        CompanyBackupPayrollRunEmploymentsProjection::dataColumns(),
                    'derived_hashes' =>
                        CompanyBackupPayrollRunEmploymentsProjection::derivedHashes(),
                    'embedded_hashes' =>
                        CompanyBackupPayrollRunEmploymentsProjection::embeddedHashes(),
                    'embedded_references' =>
                        CompanyBackupPayrollRunEmploymentsProjection::embeddedReferences(),
                    'generated_columns' => [],
                    'omit_columns' => [],
                    'references' =>
                        CompanyBackupPayrollRunEmploymentsProjection::references(),
                    'restore_overrides' => [],
                ],
            ];
        }
        ...
        $columns = match ($table) {
            ...
            'cash_document_vat_lines' =>
                CompanyBackupCashDocumentVatLinesProjection::dataColumns(),
    ...
    private static function companyBackupReferences(string $table): array
    {
        return match ($table) {
            ...
            'cash_document_vat_lines' =>
                CompanyBackupCashDocumentVatLinesProjection::references(),
