...
final class MoneyS3Reconciler
{
    ...
    private function documentsAgainstJournal(ImportContext $ctx, int $year, int $periodId): array
    {
        ...
        $spec = [
            ...
            ['purchase_invoices', 'purchase_invoices', 'd.total_with_vat', 'purchase_invoice', '321', "CASE WHEN l.side = 'credit' THEN l.signed_amount ELSE -l.signed_amount END"],
            ['issued_invoices', 'invoices', 'd.total_with_vat', 'invoice', '311', "CASE WHEN l.side = 'debit' THEN l.signed_amount ELSE -l.signed_amount END"],
