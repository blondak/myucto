 ...
 *
 * Mzdový modul pro ně nemá ani evidenci nároku, ani doložení podle § 38l, ani
 * roční částky v rulesetu. `PresentUnsupported` proto zúčtování zastaví: kdyby
 * se spočítalo bez nich, vyšel by přeplatek NIŽŠÍ, než na jaký má poplatník
 * nárok, a zaměstnanec by o rozdíl přišel, aniž by se to kdekoli projevilo.
 */
