...
#[Group('integration')]
final class CompanyBackupInvoiceItemsProjectionSchemaTest extends TestCase
{
    public function testInvoiceItemProjectionMatchesPersistedColumnsAndForeignKeys(): void
    {
