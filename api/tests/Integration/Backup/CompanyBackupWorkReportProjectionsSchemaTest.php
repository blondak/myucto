...
/** Read-only porovnání výkazů práce s fyzickým schématem izolované MariaDB. */
#[Group('integration')]
final class CompanyBackupWorkReportProjectionsSchemaTest extends TestCase
{
    /** @return array<string,array{class-string,string}> */
    public static function tables(): array
    {
        return [
            'work_reports' => [CompanyBackupWorkReportsProjection::class, 'work_reports'],
            'work_report_items' => [CompanyBackupWorkReportItemsProjection::class, 'work_report_items'],
            'work_report_materials' => [
                CompanyBackupWorkReportMaterialsProjection::class,
                'work_report_materials',
            ],
        ];
    }
