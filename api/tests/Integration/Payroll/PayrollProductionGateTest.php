...
final class PayrollProductionGateTest extends TestCase
{
    ...
    public function testTestTransportRemainsAvailableBeforeSetupIsComplete(): void
    {
    ...
    public function testProductionTransportRequiresCompletedCustomerSetup(): void
    {
    ...
    public function testProductionIsAllowedAfterOrdinarySetup(): void
    {
        $this->db->pdo()->prepare(
        ...
        $this->gate->assertEnvironmentActive($this->supplierId, 'production');
        self::addToAssertionCount(1);
    }
}
