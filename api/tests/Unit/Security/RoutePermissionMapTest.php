...
final class RoutePermissionMapTest extends TestCase
{
    public function testSpecificActionsPrecedeModuleFallbacks(): void
    {
        ...
        $cases = [
            ...
            ['POST', '/api/accounting/setup-assistant/analysis', 'accounting.templates', AccessLevel::WRITE],
            ['PUT', '/api/accounting/setup-assistant/runs/7/proposals/9', 'accounting.templates', AccessLevel::WRITE],
            ['POST', '/api/accounting/setup-assistant/runs/7/approve', 'accounting.templates', AccessLevel::WRITE],
            ['POST', '/api/accounting/setup-assistant/bundles/7/reclassification', 'accounting.journal.post', AccessLevel::WRITE],
            ['POST', '/api/accounting/setup-assistant/jobs/7/cancel', 'accounting', AccessLevel::READ],
            ...
            ['GET', '/api/payroll/deadlines/groups', 'payroll.submissions', AccessLevel::READ],
            ['GET', '/api/payroll/deadlines/items', 'payroll.submissions', AccessLevel::READ],
