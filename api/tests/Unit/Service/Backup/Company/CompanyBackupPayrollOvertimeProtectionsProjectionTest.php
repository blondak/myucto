...
final class CompanyBackupPayrollOvertimeProtectionsProjectionTest extends TestCase
{
    /** @var list<string> */
    ...
    public function testDeclaresExactOvertimeProtectionProjection(): void
    {
        $registry = TenantDataRegistryFactory::draftV1();
        $definition = $registry->definition('table:payroll_overtime_protections');
