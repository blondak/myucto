...
final class CompanyBackupPayrollPersonHealthCoverageProjectionTest extends TestCase
{
    /** @var list<string> */
    ...
    public function testDeclaresExactHealthCoverageProjectionAndPreservesEvidence(): void
    {
