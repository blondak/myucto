...
final class CompanyBackupPayrollPersonSocialDiscountClaimsProjectionTest extends TestCase
{
    /** @var list<string> */
    ...
    public function testDeclaresExactSocialDiscountProjectionAndPreservesEvidence(): void
    {
        ...
        self::assertSame(
            [
                'status' => 'verified',
                'evidence_reference' => 'document:synthetic-social-discount',
            ],
