...
final class CompanyBackupPayrollPersonTaxDeclarationsProjectionTest extends TestCase
{
    /** @var list<string> */
    ...
    public function testDeclaresExactTaxDeclarationProjectionAndPreservesEvidence(): void
    {
