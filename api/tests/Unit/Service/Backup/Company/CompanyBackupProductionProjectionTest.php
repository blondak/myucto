...
final class CompanyBackupProductionProjectionTest extends TestCase
{
    ...
    public function testAssetsDeclareCompletePayloadAndSemanticReferences(): void
    {
        $registry = TenantDataRegistryFactory::draftV1();
        $definition = $registry->definition('table:assets');
        self::assertNotNull($definition);
        $projection = CompanyBackupTableProjection::fromDefinition($definition);
        $columns = [
            'id',
        ...
        self::assertSame(
            [
                ...
                'supplier_id,accumulated_account_code'
                    . '->chart_of_accounts:supplier_id,account_code',
                'supplier_id,acquisition_account_code'
                    . '->chart_of_accounts:supplier_id,account_code',
                'supplier_id,asset_account_code'
                    . '->chart_of_accounts:supplier_id,account_code',
                'supplier_id->supplier:id',
            ],
            array_map(
    ...
    public function testAssetImprovementsDeclareCompletePayloadAndReferences(): void
    {
        $registry = TenantDataRegistryFactory::draftV1();
        $definition = $registry->definition('table:asset_improvements');
        self::assertNotNull($definition);
        $projection = CompanyBackupTableProjection::fromDefinition($definition);
        $columns = [
            'id',
    ...
    public function testStockTagsDeclareCompletePayloadAndNaturalKey(): void
    {
        $registry = TenantDataRegistryFactory::draftV1();
        $definition = $registry->definition('table:stock_tags');
        self::assertNotNull($definition);
        $projection = CompanyBackupTableProjection::fromDefinition($definition);
        $columns = [
            'id',
    ...
    public function testStockItemTagsRemapBothCompositeKeyOwners(): void
    {
        $registry = TenantDataRegistryFactory::draftV1();
        $definition = $registry->definition('table:stock_item_tags');
        self::assertNotNull($definition);
        $projection = CompanyBackupTableProjection::fromDefinition($definition);
        $columns = [
            'supplier_id',
    ...
    {
        $registry = TenantDataRegistryFactory::draftV1();
        $definition = $registry->definition('table:stock_fee_types');
        self::assertNotNull($definition);
        $projection = CompanyBackupTableProjection::fromDefinition($definition);
        $columns = [
            'id',
    ...
    public function testStockItemPricesDeclareCompletePayloadAndNaturalKey(): void
    {
        $registry = TenantDataRegistryFactory::draftV1();
        $definition = $registry->definition('table:stock_item_prices');
        self::assertNotNull($definition);
        $projection = CompanyBackupTableProjection::fromDefinition($definition);
        $columns = [
            'id',
    ...
    public function testStockLocalesDeclareCompletePayloadAndNaturalKey(): void
    {
        $registry = TenantDataRegistryFactory::draftV1();
        $definition = $registry->definition('table:stock_locales');
        self::assertNotNull($definition);
        $projection = CompanyBackupTableProjection::fromDefinition($definition);
        $columns = [
            'id',
    ...
    public function testStockCurrenciesDeclareCompletePayloadAndNaturalKey(): void
    {
        $registry = TenantDataRegistryFactory::draftV1();
        $definition = $registry->definition('table:stock_currencies');
        self::assertNotNull($definition);
        $projection = CompanyBackupTableProjection::fromDefinition($definition);
        $columns = [
            'id',
    ...
    public function testStockItemI18nDeclareCompletePayloadAndNaturalKey(): void
    {
        $registry = TenantDataRegistryFactory::draftV1();
        $definition = $registry->definition('table:stock_item_i18n');
        self::assertNotNull($definition);
        $projection = CompanyBackupTableProjection::fromDefinition($definition);
        $columns = [
            'id',
