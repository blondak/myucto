...
\DG\BypassFinals::allowPaths([
    ...
    '*/api/src/Service/Payroll/Submission/Registration/PayrollRegistrationIdentityService.php',
    '*/api/src/Repository/Payroll/PayrollRegistrationIdentityRepository.php',
    '*/api/src/Repository/Payroll/PayrollEmploymentRepository.php',
    '*/api/src/Service/Tenant/PublicTenantGuard.php',
    '*/api/src/Service/WorkReport/WorkReportLinkService.php',
    ...
    '*/api/src/Repository/BankConnectionRepository.php',
    '*/api/src/Repository/Payroll/PayrollBankSubmissionSourceRepository.php',
    '*/api/src/Service/Bank/Connector/BankPaymentSubmissionService.php',
    '*/api/src/Service/Payroll/Payment/PayrollPaymentExportService.php',
    '*/api/src/Service/Payroll/Payment/PayrollPaymentExportStorage.php',
    '*/api/src/Repository/KbPlusOAuthRepository.php',
    '*/api/src/Repository/CsasOAuthRepository.php',
    '*/api/src/Service/Bank/Connector/CsasApiClient.php',
    '*/api/src/Service/Bank/Connector/CsasCredentialVault.php',
    '*/api/src/Service/Bank/Connector/KbPlusApiClient.php',
    '*/api/src/Service/Bank/Connector/KbPlusCredentialVault.php',
    '*/api/src/Service/Bank/Connector/KbPlusRegistrationClient.php',
    '*/api/src/Service/Bank/Connector/KbPlusRegistrationService.php',
    '*/api/src/Repository/BankPaymentOrderSubmissionRepository.php',
    '*/api/src/Repository/PaymentOrderRepository.php',
    ...
    '*/api/src/Repository/JournalEntryRepository.php',
    '*/api/src/Repository/AccountingPeriodRepository.php',
    ...
    '*/api/src/Service/Accounting/Bank/BankPostingService.php',
    ...
    '*/api/src/Service/Bank/StatementMatcher.php',
    '*/api/src/Service/Bank/Connector/BankConnectorCallGuard.php',
    '*/api/src/Service/Bank/Connector/BankConnectorRegistry.php',
    '*/api/src/Service/Bank/GpcParser.php',
    '*/api/src/Service/Bank/StatementImporter.php',
    '*/api/src/Service/Payment/PaymentOrderService.php',
    '*/api/src/Service/Bank/EmailNoticeReconciler.php',
