...
REM    schtasks /create /tn "MyUcto Approval Reminders" ^
...
"%PHP_BIN%" "%PROJECT_ROOT%\api\bin\cron-send-approval-reminders.php" %* >> "%LOG_DIR%\send-approval-reminders-%TODAY%.log" 2>&1
exit /b %ERRORLEVEL%
