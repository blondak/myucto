...
## 102.1 Co všechno se aktualizuje
...
## 102.2 Pravidelná kontrola — jak funguje
...
## 102.3 Patička aplikace a upozornění na aktualizaci
...
### 102.4.1 Test režim (jednorázově, ve foregroundu)
...
### 102.4.2 Instalace watcheru jako daemon (na produkci)
...
## 102.5 Persistentní data v Dockeru
...
## 102.6 Aktualizace v UI — nativní instalace
...
### 102.6.4 Když automatická cesta nejde
...
## 102.7 Co když upgrade selže

### 102.7.1 Docker watcher
...
## 102.8 Dohled na nové verze bez UI
