...
## 103.1 Co všechno se aktualizuje
...
## 103.2 Pravidelná kontrola — jak funguje
...
## 103.3 Patička aplikace a upozornění na aktualizaci
...
### 103.4.1 Test režim (jednorázově, ve foregroundu)
...
### 103.4.2 Instalace watcheru jako daemon (na produkci)
...
## 103.5 Persistentní data v Dockeru
...
## 103.6 Aktualizace v UI — nativní instalace
...
### 103.6.4 Když automatická cesta nejde
...
## 103.7 Co když upgrade selže

### 103.7.1 Docker watcher
...
## 103.8 Dohled na nové verze bez UI
