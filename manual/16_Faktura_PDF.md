...
| Účetní období je uzavřené | Do uzavřeného období nelze účtovat — viz [Uzávěrka](66_Uzaverka.md). |
| Účetní zápis není vyvážený (MD ≠ Dal) | Zkontroluj předkontaci a částky dokladu. |
| V účtové osnově chybí potřebný účet | Chybí nebo je deaktivovaný účet v předkontaci — doplň/aktivuj v [Účtovém rozvrhu](60_Ucetni_osnova.md). |
...
viz [§ 71.11 Automatické zaúčtování](71_Nastaveni.md#7111-automaticke-zauctovani-pri-vystaveniprijeti-dokladu).
...
klienta) — viz [71. Nastavení](71_Nastaveni.md).
...
Detail nastavení je v [kapitole 49. Elektronické podpisy](72_Elektronicke_podpisy.md).
