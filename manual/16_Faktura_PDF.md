...
faktura sama o sobě do [Účetního deníku](44_Ucetni_denik.md) nic nezapíše.
...
| Účetní období je uzavřené | Do uzavřeného období nelze účtovat — viz [Uzávěrka](67_Uzaverka.md). |
| Účetní zápis není vyvážený (MD ≠ Dal) | Zkontroluj předkontaci a částky dokladu. |
| V účtové osnově chybí potřebný účet | Chybí nebo je deaktivovaný účet v předkontaci — doplň/aktivuj v [Účtovém rozvrhu](61_Ucetni_osnova.md). |
...
viz [§ 72.11 Automatické zaúčtování](72_Nastaveni.md#7211-automaticke-zauctovani-pri-vystaveniprijeti-dokladu).
...
klienta) — viz [72. Nastavení](72_Nastaveni.md).
...
Detail nastavení je v [kapitole 49. Elektronické podpisy](73_Elektronicke_podpisy.md).
