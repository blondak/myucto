...
> [Hromadný export (ZIP)](48_Hromadny_export.md). Exporty níže
...
sazbu ani příznak [OSS](45_OSS.md) v datovém formátu nemá kam zapsat. Export takový doklad proto **odmítne a řekne to**, místo aby polskou
...
- **Vše v jednom balíčku** — když účetní chce za měsíc kompletní podklad
  ...
  [Hromadný export (ZIP)](48_Hromadny_export.md) v sekci Daně —
