...
řádek otevře [detail karty](#283-detail-karty-a-plan-odpisu).
...
### 28.1.1 Založení z přijaté faktury
...
### 28.2.1 Zámky po zařazení a potvrzení
...
## 28.3 Detail karty a plán odpisů
...
**⏸** (přerušení §26/8, viz [§ 28.5](#285-preruseni-danoveho-odpisu)).
...
## 28.4 Zařazení do užívání, technické zhodnocení, vyřazení

Akce dostupné v hlavičce detailu se mění podle stavu karty.

### 28.4.1 Zařazení do užívání
...
### 28.4.2 Technické zhodnocení (§33)
...
### 28.4.3 Vyřazení a vrácení vyřazení
...
- zaúčtuje **účetní odpis roku** (MD nákladový účet z kontace
  ...
  odpovídající řádek do [Účetního deníku](52_Ucetni_denik.md) se zdrojem
  „odpis" — přes [PostingService](52_Ucetni_denik.md) se stejnou
...
> (viz [Uzávěrka](72_Uzaverka.md)) — po uzavření období už
> zápis pro daný rok zaúčtovat nejde.

## 28.7 Import a export Excelem
...
> odepsáno dosud" ([§ 28.2](#282-zalozeni-a-uprava-karty)), bez nutnosti
...
- **Vrácení vyřazení** funguje, jen dokud je účetní období data vyřazení
  otevřené — po uzávěrce (viz [Uzávěrka](72_Uzaverka.md)) už
