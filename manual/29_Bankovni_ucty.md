...
(tečkovaný zápis, viz [§ 84.3.1](84_Ucetni_osnova.md#8431-teckovany-zapis-analytik))
Číslo se přiděluje **automaticky** (první volné, které v
[účtovém rozvrhu](84_Ucetni_osnova.md) nekoliduje s už existujícím účtem) a
...
- **cizoměnové účty se přeceňují automaticky** — jednoměnová analytika už
  nemíchá měny, takže ji [uzávěrkové přecenění](91_Uzaverka.md) nabídne samo,
...
vlastními účty — potřebují vlastní **účetní zápis** (MD/D dle [Předkontace](92_Ucetni_nastroje.md#923-predkontace)).
...
| MD účet / D účet | Kontace zápisu — účty musí existovat v [účtovém rozvrhu](84_Ucetni_osnova.md) |
...
- **Schválit** — vytvoří zápis do deníku (viz [Předkontace](92_Ucetni_nastroje.md#923-predkontace)
...
ručně v [Předkontace](92_Ucetni_nastroje.md#923-predkontace).
