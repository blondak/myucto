...
viz [28. Banka](29_Banka.md)), dvě záložky účetní automatiky — **K zaúčtování**
a **Pravidla účtování** (viz [§ 30.8](#308-automaticke-zauctovani-bankovnich-transakci-jen-podvojne-ucetnictvi),
...
stejně jako z [výpisu](29_Banka.md).
...
### 30.1.2 Kontace účtů — analytika 221 (jen podvojné účetnictví)
...
(tečkovaný zápis, viz [§ 84.3.1](66_Ucetni_osnova.md#6631-teckovany-zapis-analytik))
Číslo se přiděluje **automaticky** (první volné, které v
[účtovém rozvrhu](66_Ucetni_osnova.md) nekoliduje s už existujícím účtem) a
...
- **cizoměnové účty se přeceňují automaticky** — jednoměnová analytika už
  nemíchá měny, takže ji [uzávěrkové přecenění](72_Uzaverka.md) nabídne samo,
...
### 30.1.4 Odeslání příkazu do banky
...
## 30.3 Vaše nastavení pro načítání bankovních avíz a PDF z e-mailů
...
### 30.3.2 Načítání PDF faktur z příloh
...
## 30.5 Příklad regex provideru pro Raiffeisenbank
...
## 30.6 Test parseru a zpracované e-maily
...
### 30.6.1 Když k avízu dorazí GPC výpis
...
## 30.8 Automatické zaúčtování bankovních transakcí (jen podvojné účetnictví)

Bankovní výpis ([kapitola 28](29_Banka.md)) i e-mailové avízo (§ 30.2–29.7) řeší jen **párování na
...
vlastními účty — potřebují vlastní **účetní zápis** (MD/D dle [Předkontace](73_Ucetni_nastroje.md#733-predkontace)).
...
| MD účet / D účet | Kontace zápisu — účty musí existovat v [účtovém rozvrhu](66_Ucetni_osnova.md) |
| Režim | **Návrh**, nebo **Automaticky** (§ 30.8.2) |
...
- **Bankovní strana musí být účet 221** (dle směru — příchozí = MD 221,
  ...
  ze kterého je výpis** ([§ 30.1.2](#3012-kontace-uctu-analytika-221-jen-podvojne-ucetnictvi)),
...
### 30.8.2 Režim Návrh vs. Automaticky
...
### 30.8.3 Schvalování návrhů a záložka „K zaúčtování"
...
- **Schválit** — vytvoří zápis do deníku (viz [Předkontace](73_Ucetni_nastroje.md#733-predkontace)
...
ručně v [Předkontace](73_Ucetni_nastroje.md#733-predkontace).
...
### 30.8.4 Založení pravidla přímo z platby
