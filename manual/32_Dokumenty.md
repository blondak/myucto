...
[fronty K doúčtování](50_Rucni_fronta_doctovani.md). U bankovního pohybu se jeho
existence ukáže v [Úplnosti dokladů](57_Uplnost_dokladu.md), ale pohyb z kontroly
...
zde v sekci Dokumenty**, ale přímo v detailu zápisu v [Účetním deníku](48_Ucetni_denik.md) —
...
- Typ souboru se stejně jako u Dokumentů poznává **z obsahu**, ne z přípony;
  ...
  blocklistem jako v [§ Bezpečnost](#3213-bezpecnost).
...
> [!WARNING]
> Plánovaná úloha `cron-backup-documents` (viz [§ Zálohování](#3212-zalohovani) níže)
