...
promítá do [Účetního deníku](52_Ucetni_denik.md).
...
- **Účet** — analytika účtu 211 z účtové osnovy firmy (např. `211.100` — o tečkovaném
  zápisu viz [§ 84.3.1](66_Ucetni_osnova.md#6631-teckovany-zapis-analytik)). Nabízí se jen aktivní účty
...
### 32.1.2 Správa existujících pokladen
...
## 32.2 Hlavní stránka pokladny — přehled dokladů
...
- **Tlačítka Příjem (PPD)** a **Výdej (VPD)** pro vystavení nového dokladu — zelené pro příjem,
  oranžové pro výdej.
- **Odkaz na Pokladní knihu** (§ 32.5).

### 32.2.1 Filtry a sloupce seznamu
...
### 32.2.2 Přílohy pokladního dokladu
...
- **Tisk** — otevře PDF dokladu (§ 32.4).
- **Storno** — jen u zaúčtovaného dokladu (§ 32.3.5).

Stránka podporuje serverové stránkování (50 dokladů na stránku).

## 32.3 Vystavení pokladního dokladu (PPD/VPD)
...
z editoru faktury volbou způsobu úhrady „Hotově" (§ 32.3.6).

### 32.3.1 Hlavička dokladu
...
partnera. Volitelně lze doklad vystavit s DPH (viz § 32.3.3).
...
### 32.3.3 DPH na pokladním dokladu
...
### 32.3.4 Částka, popis a náhled zaúčtování
...
### 32.3.6 Doklad vzniklý z faktury (hotovostní vyrovnání)
...
pokladně (§ 32.6). Analytika 211 se i tady bere z karty zvolené pokladny.
...
(§ 32.3.2) — pokladna umí i navazující daňový doklad k platbě.

## 32.4 Tisk pokladního dokladu
...
## 32.6 Zaúčtování a vazba na deník

V podvojném účetnictví se každý zaúčtovaný pokladní doklad promítá standardním způsobem do
[Účetního deníku](52_Ucetni_denik.md) — konkrétní účtovací předpis (MD/D) se liší podle účelu
dokladu:
...
Firmy s analytikami DPH ([§ 84.3.2](66_Ucetni_osnova.md#6632-analytiky-dph-343100-343200-a-343900))
...
([§ 84.3.3](66_Ucetni_osnova.md#6633-mesicni-zuctovani-dph)). Firma, která analytiky nemá,
...
- Doklad, jednou zaúčtovaný, se needituje ani nemaže — jedinou opravou je storno s uvedením
  ...
  (§ 32.3.6), který faktura umí zase zrušit.
- Hotovostní vyrovnání z editoru faktury (§ 32.3.6) neumí zálohové faktury, pravidelné
