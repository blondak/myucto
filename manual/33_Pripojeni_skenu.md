...
Každý sken se nejdřív uloží do sekce [Dokumenty](32_Dokumenty.md) (složka
...
z [knihy jízd](34_Kniha_jizd.md). Když IČO chybí, rozhoduje jméno odběratele;
...
- Účtenka za pohonné hmoty připojená k přijaté faktuře nebo pokladnímu dokladu
  založí nebo doplní tankování v [knize jízd](34_Kniha_jizd.md), pokud firma knihu
...
- V [měsíční kontrole](91_Uzaverka.md#917-mesicni-kontrola) a v předběžných
  kontrolách uzávěrky.
