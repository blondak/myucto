...
v [Nastavení](71_Nastaveni.md) zapnutý modul **Sklad**)*
...
> **Ceník** ([§ 71.1.5](71_Nastaveni.md)) je určený pro fakturaci služeb a umí
...
- Modul E-shop je **dostupný jen se zapnutým Skladem** — bez něj se položka v
  menu vůbec nezobrazí (nastavuje se v [§ 53. Nastavení](71_Nastaveni.md)).
...
|---|---|
| **Cenové hladiny / skupiny zákazníků** | Ceny per zákazník existují jen v jednoduchém **Ceníku** pro fakturaci ([§ 71.1.5](71_Nastaveni.md)), který se se skladem nekombinuje |
