...
## 35.2 Jak aplikace skeny páruje

Každý sken se nejdřív uloží do sekce [Dokumenty](34_Dokumenty.md) (složka
...
z [knihy jízd](36_Kniha_jizd.md). Když IČO chybí, rozhoduje jméno odběratele;
...
- Účtenka za pohonné hmoty připojená k přijaté faktuře nebo pokladnímu dokladu
  založí nebo doplní tankování v [knize jízd](36_Kniha_jizd.md), pokud firma knihu
...
## 35.5 Rozpory dokladů s přílohami
...
- V [měsíční kontrole](72_Uzaverka.md#727-mesicni-kontrola) a v předběžných
  kontrolách uzávěrky.
