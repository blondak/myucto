...
Kapitola má dvě části: **§ 36.1–34.7** popisují číselníky a import na stránce
`/eshop`, **§ 36.8–34.10** pak cenotvorbu a dodavatele, které se zadávají přímo
na kartě zboží. Číselník jazyků je popsaný samostatně v
[§ 36.13](#3613-jazyky). Pokud tě zajímá jen nacenění katalogu, začni
[§ 36.8](#368-cenotvorba).
...
> [§ 35.9 Kolik toho vlastně máš](35_Sklad.md#359-kolik-toho-vlastne-mas-skladem-rezervovano-na-ceste-u-dodavatele).

## 36.1 Přehled záložek
...
nabídne archivaci místo mazání (viz [§ 36.11](#3611-mazani-vs-archivace)).
...
### 36.4.1 Volby atributu (jen typ Enum)
...
### 36.7.2 Předvolby ABRA Flexi a POHODA
...
### 36.8.2 Nákupní cena — cenová báze
...
v [§ 35.3 Oceňování zásob](35_Sklad.md).
...
### 36.8.3 Přirážka vs. marže — nepleť si je
...
| **Zaokrouhlení** | Bez / na haléře / desetihaléře / půlkoruny / koruny / na 9 na konci ([§ 36.8.5](#3685-zaokrouhleni)) |
...
| **Chybí kurz** — v kurzovním lístku není kurz dané měny | Doplň kurz ([§ 36.8.6](#3686-cizi-meny-a-kurzy)) a spusť přepočet |
...
- **Sleva** na kartě zboží se dělá **akční cenou** ([§ 36.8.9](#3689-akcni-ceny)).
...
| **Skladem (ks)** | Množství, které dodavatel drží — orientační, needituje tvůj sklad; sčítá se do veličiny **U dodavatele** ([§ 35.9.4](35_Sklad.md#3594-u-dodavatele)) |
...
> v [§ 35.10 Nabídky dodavatelů](35_Sklad.md#3510-nabidky-dodavatelu-u-dodavatele).
> Právě minimální odběr a balení používá návrh
> [doplnění zásob](35_Sklad.md#3512-doplneni-zasob-co-objednat).

### 36.9.1 Preferovaný dodavatel

Preferovaný dodavatel je ten, jehož **nákupní cena se použije při cenové bázi
„Ruční"** a jako poslední článek záložního řetězu ([§ 36.8.2](#3682-nakupni-cena-cenova-baze)).
...
### 36.9.2 Dropshipping — zboží bez skladu
...
> [doplnění zásob](35_Sklad.md#3512-doplneni-zasob-co-objednat) pracuje jen
...
> [objednávku](35_Sklad.md#3511-objednavky-u-dodavatele) ručně.

## 36.10 Praktické postupy cenotvorby

### 36.10.1 Nacenění nového skladového zboží
...
4. Záložka **Ceny**, připravený řádek `CZK`, režim **Přirážka %**, hodnota podle
   cílové marže (viz převodní tabulka v [§ 36.8.3](#3683-prirazka-vs-marze-neplet-si-je)),
   zaokrouhlení **Na koruny** nebo **Na 9 na konci**.
5. **„Přepočítat"** a zkontroluj sloupec „Výsledná cena".

### 36.10.2 Nacenění dropshippingového zboží
...
### 36.10.3 Změna dodavatele nebo jeho ceníku
...
[§ 35.10.2](35_Sklad.md#35102-import-ceniku-dodavatele); tamtéž je i upozornění,
že v tomto vydání tlačítko importu ještě nedoběhne.

### 36.10.4 Kontrola marže
...
- **nákupní cenu** — ve skladových sestavách (ocenění zásob,
  [§ 35.8](35_Sklad.md#358-skladove-sestavy)) nebo na záložce Dodavatelé,
...
### 36.10.5 Akce a výprodej

Na akční ceny má karta vlastní sekci na záložce „Ceny" —
[§ 36.8.9](#3689-akcni-ceny). Postup:
...
4. Zboží v akci si můžeš navíc označit **tagem** (např. „Výprodej",
   [§ 36.5](#365-tagy)) kvůli filtrování a exportu.
...
## 36.12 Omezení a tipy

### 36.12.1 Číselníky a import
...
| **Částečné uplatnění akce v jednom řádku** | Akce je vše nebo nic per řádek — rozděl řádek ([§ 36.8.9](#3689-akcni-ceny)) |
| **Historie cen** | Není — uchovává se jen aktuální hodnota a datum posledního přepočtu |
| **Automatický feed nákupních cen od dodavatele** | Ceník se importuje ručně z XLSX/CSV ([§ 35.10.2](35_Sklad.md#35102-import-ceniku-dodavatele)), online napojení na dodavatele není |
...
## 36.14 Varianty a vztahy produktů
...
### 36.16.6 Webhook a podklady pro vývojáře
...
### 36.16.7 Stahování změn katalogu
...
### 36.16.8 Aktivace a provozní limity
...
### 36.16.9 Diagnostika, opakování a porovnání úplnosti
