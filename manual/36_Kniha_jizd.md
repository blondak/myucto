...
### 36.1.1 Řidič, režim užívání a odpočet DPH
...
a počítá se v [Daních](41_Vykazy_DPH.md).
...
doklad ([přijatá faktura](23_Prijate_faktury.md), [pokladní doklad](32_Pokladna.md)),
...
### 36.3.3 Načíst z faktur od stanic
...
### 36.3.4 Tankování z pokladních dokladů

Účtenku za PHM zaplacenou hotově zaúčtuješ v [Pokladně](32_Pokladna.md) jako výdajový
...
### 36.3.5 Import tankování z CSV / XLSX
...
Aby krok s kartou fungoval, veď kartu v [Platebních kartách](31_Platebni_karty.md)
...
### 36.3.8 Tankování ze skenů účtenek

Když [dávka skenů](35_Pripojeni_skenu.md) připojí sken k přijaté faktuře nebo
