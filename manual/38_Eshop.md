...
Kapitola má dvě části: **§ 38.1–34.7** popisují číselníky a import na stránce
`/eshop`, **§ 38.8–34.10** pak cenotvorbu a dodavatele, které se zadávají přímo
na kartě zboží. Číselník jazyků je popsaný samostatně v
[§ 38.13](#3813-jazyky). Pokud tě zajímá jen nacenění katalogu, začni
[§ 38.8](#388-cenotvorba).
...
> [§ 35.9 Kolik toho vlastně máš](37_Sklad.md#379-kolik-toho-vlastne-mas-skladem-rezervovano-na-ceste-u-dodavatele).

## 38.1 Přehled záložek
...
### 38.4.1 Volby atributu (jen typ Enum)
...
### 38.7.2 Předvolby ABRA Flexi a POHODA
...
> **Ceník** ([§ 96.1.5](96_Nastaveni.md)) je určený pro fakturaci služeb a umí
...
### 38.8.2 Nákupní cena — cenová báze
...
v [§ 35.3 Oceňování zásob](37_Sklad.md).
...
### 38.8.3 Přirážka vs. marže — nepleť si je
...
| **Zaokrouhlení** | Bez / na haléře / desetihaléře / půlkoruny / koruny / na 9 na konci ([§ 38.8.5](#3887-zaokrouhleni)) |
...
| **Chybí kurz** — v kurzovním lístku není kurz dané měny | Doplň kurz ([§ 38.8.6](#3888-cizi-meny-a-kurzy)) a spusť přepočet |
...
- **Sleva** na kartě zboží se dělá **akční cenou** ([§ 38.8.9](#38811-akcni-ceny)).
...
### 38.8.12 Individuální ceny zákazníků
...
| **Skladem (ks)** | Množství, které dodavatel drží — orientační, needituje tvůj sklad; sčítá se do veličiny **U dodavatele** ([§ 35.9.4](37_Sklad.md#3794-u-dodavatele)) |
...
> v [§ 35.10 Nabídky dodavatelů](37_Sklad.md#3710-nabidky-dodavatelu-u-dodavatele).
> Právě minimální odběr a balení používá návrh
> [doplnění zásob](37_Sklad.md#3712-doplneni-zasob-co-objednat).

### 38.9.1 Preferovaný dodavatel

Preferovaný dodavatel je ten, jehož **nákupní cena se použije při cenové bázi
„Ruční"** a jako poslední článek záložního řetězu ([§ 38.8.2](#3882-nakupni-cena-cenova-baze)).
...
### 38.9.2 Dropshipping — zboží bez skladu
...
> [doplnění zásob](37_Sklad.md#3712-doplneni-zasob-co-objednat) pracuje jen
...
> [objednávku](37_Sklad.md#3711-objednavky-u-dodavatele) ručně.

## 38.10 Praktické postupy cenotvorby

### 38.10.1 Nacenění nového skladového zboží
...
4. Záložka **Ceny**, připravený řádek `CZK`, režim **Přirážka %**, hodnota podle
   cílové marže (viz převodní tabulka v [§ 38.8.3](#3883-prirazka-vs-marze-neplet-si-je)),
   zaokrouhlení **Na koruny** nebo **Na 9 na konci**.
5. **„Přepočítat"** a zkontroluj sloupec „Výsledná cena".

### 38.10.2 Nacenění dropshippingového zboží
...
### 38.10.3 Změna dodavatele nebo jeho ceníku
...
[§ 35.10.2](37_Sklad.md#37102-import-ceniku-dodavatele); tamtéž je i upozornění,
že v tomto vydání tlačítko importu ještě nedoběhne.

### 38.10.4 Kontrola marže
...
- **nákupní cenu** — ve skladových sestavách (ocenění zásob,
  [§ 35.8](37_Sklad.md#378-skladove-sestavy)) nebo na záložce Dodavatelé,
...
### 38.10.5 Akce a výprodej

Na akční ceny má karta vlastní sekci na záložce „Ceny" —
[§ 38.8.9](#38811-akcni-ceny). Postup:
...
4. Zboží v akci si můžeš navíc označit **tagem** (např. „Výprodej",
   [§ 38.5](#385-tagy)) kvůli filtrování a exportu.
...
## 38.12 Omezení a tipy

### 38.12.1 Číselníky a import

- Modul E-shop je **dostupný jen se zapnutým Skladem** — bez něj se položka v
  menu vůbec nezobrazí (nastavuje se v [§ 53. Nastavení](96_Nastaveni.md)).
...
| **Automatický feed nákupních cen od dodavatele** | Ceník se importuje ručně z XLSX/CSV ([§ 35.10.2](37_Sklad.md#37102-import-ceniku-dodavatele)), online napojení na dodavatele není |
...
### 38.16.6 Webhook a podklady pro vývojáře
...
### 38.16.7 Stahování změn katalogu
...
### 38.16.8 Aktivace a provozní limity
...
### 38.16.9 Diagnostika, opakování a porovnání úplnosti
...
([§ 35.2.6](37_Sklad.md#3728-baleni)), protože karton jednoho zboží obsahuje jiný
...
cena vyhraje jen tehdy, když je levnější (viz [§ 38.8.10](#38812-individualni-ceny-zakazniku)).
