# 38. Fakturujeme — daňový průvodce
...
[39. Výkazy DPH](39_Vykazy_DPH.md).

## 38.1 Daňový status firmy — plátce, neplátce, identifikovaná osoba
...
### 38.1.1 Status se vede v čase, ne jako jeden přepínač
...
- **Výkazy DPH** posuzují plátcovství **ke konci období výkazu**, ne podle
  dnešního stavu — viz [§ 36](39_Vykazy_DPH.md).
...
### 38.1.2 Co se na dokladu mění u neplátce
...
### 38.1.3 Kdy se plátcem staneš ze zákona (§ 6 a § 94 ZDPH)
...
### 38.1.4 Identifikovaná osoba (§ 6g–6l ZDPH)
...
### 38.1.5 Vznik a zrušení registrace — § 79 a § 79a
...
[§ 36 — Opravy DPH](39_Vykazy_DPH.md#397-opravy-dph-43-79-a-79a).

## 38.2 Sazby DPH a klasifikace

### 38.2.1 Číselník sazeb
...
([§ 96.1.2](96_Nastaveni.md#9612-sazby-dph)). Můžeš přidávat další (typicky sazby
...
> chybou. Detail v [§ 43.2.2](43_OSS.md#4332-sazby-dph-pro-cizi-zeme-hlidej-pole-stat).
...
> [§ 36](39_Vykazy_DPH.md#399-zmena-sazby-dph-s-budouci-platnosti).

### 38.2.2 Klasifikace DPH — co doklad opravdu zařadí do výkazů
...
Detail v [§ 36 — VAT klasifikační kódy](39_Vykazy_DPH.md#3944-jak-funguji-vat-klasifikacni-kody)
a [§ 96.14](96_Nastaveni.md#9614-system-sazby-a-ciselniky).

## 38.3 Datum plnění, zálohy a zjednodušený doklad

### 38.3.1 DUZP je to, co rozhoduje
...
### 38.3.2 Zálohová faktura není daňový doklad
...
[v režimu OSS](43_OSS.md#438-uctovani-oss-dane) (daň se přiznává ke dni přijetí
...
### 38.3.3 Zjednodušený daňový doklad (§ 30 ZDPH)
...
## 38.4 Reverse charge (přenesená daňová povinnost)
...
[souhrnném hlášení](42_Souhrnne_hlaseni.md).

### 38.4.2 Jak RC zapnout
...
> ([§ 38.1.4](#3814-identifikovana-osoba-6g-6l-zdph)), které se RC u EU klienta
> s DIČ zapne automaticky.

RC doklad v cizí měně má vlastní pravidla přepočtu pro výkazy — viz
[§ 36](39_Vykazy_DPH.md#3947-reverse-charge-v-cizi-mene).

## 38.5 Zahraniční fakturace — EU, OSS a třetí země

### 38.5.1 Co aplikace pokrývá
...
### 38.5.2 OSS (One Stop Shop) — co dělá aplikace sama

Režim OSS má **vlastní kapitolu:** [43. Režim OSS (One Stop Shop)](43_OSS.md) —
...
> [§ 43.8.5](43_OSS.md#4395-kde-se-oss-priznani-podava). Před podáním vždy ověř
> sazby, zemi spotřeby, přepočet a výsledné XML s účetní nebo daňovým poradcem.

### 38.5.3 Export mimo EU není reverse charge
...
### 38.5.4 Registrace k DPH ve více zemích
...
v hlavičce — viz [95. Více dodavatelů](95_Multi_supplier.md). **Není to
plnohodnotná multi-jurisdikční podpora**: přiznání k DPH pro každou zemi řeš
s místní účetní.

## 38.6 Co MyÚčto dělá a co nedělá
...
- **Mzdy** — [úplný mzdový modul](61_Uplne_mzdy.md) (osobní karty, pracovní
  ...
  i jednodušší [Mzdovou rekapitulaci](60_Mzdy.md); úplné mzdy zatím používejte
...
- **Podání na EPO** ve dvou režimech: **přímé podání se ZAREP** (uznávaný
  ...
  formuláře) — viz [93. EPO podání a archiv](93_Archiv_podani_a_rekonciliace.md)
...
### 38.6.2 MyÚčto **nedělá**

- **Produkční mzdy jako jediný zdroj — zatím.** [Mzdový modul](61_Uplne_mzdy.md)
...
→ Pokračuj na [39. Výkazy DPH](39_Vykazy_DPH.md), [43. Režim OSS](43_OSS.md),
