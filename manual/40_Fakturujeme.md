...
[39. Výkazy DPH](41_Vykazy_DPH.md).

## 40.1 Daňový status firmy — plátce, neplátce, identifikovaná osoba
...
### 40.1.1 Status se vede v čase, ne jako jeden přepínač
...
- **Výkazy DPH** posuzují plátcovství **ke konci období výkazu**, ne podle
  dnešního stavu — viz [§ 36](41_Vykazy_DPH.md).
...
### 40.1.2 Co se na dokladu mění u neplátce
...
### 40.1.3 Kdy se plátcem staneš ze zákona (§ 6 a § 94 ZDPH)
...
### 40.1.4 Identifikovaná osoba (§ 6g–6l ZDPH)
...
### 40.1.5 Vznik a zrušení registrace — § 79 a § 79a
...
[§ 36 — Opravy DPH](41_Vykazy_DPH.md#417-opravy-dph-43-79-a-79a).

## 40.2 Sazby DPH a klasifikace

### 40.2.1 Číselník sazeb
...
> chybou. Detail v [§ 43.2.2](45_OSS.md#4532-sazby-dph-pro-cizi-zeme-hlidej-pole-stat).
...
> [§ 36](41_Vykazy_DPH.md#419-zmena-sazby-dph-s-budouci-platnosti).

### 40.2.2 Klasifikace DPH — co doklad opravdu zařadí do výkazů
...
Detail v [§ 36 — VAT klasifikační kódy](41_Vykazy_DPH.md#4144-jak-funguji-vat-klasifikacni-kody)
a [§ 96.14](96_Nastaveni.md#9614-system-sazby-a-ciselniky).

## 40.3 Datum plnění, zálohy a zjednodušený doklad

### 40.3.1 DUZP je to, co rozhoduje
...
### 40.3.2 Zálohová faktura není daňový doklad
...
[v režimu OSS](45_OSS.md#458-uctovani-oss-dane) (daň se přiznává ke dni přijetí
...
### 40.3.3 Zjednodušený daňový doklad (§ 30 ZDPH)
...
## 40.4 Reverse charge (přenesená daňová povinnost)
...
[souhrnném hlášení](44_Souhrnne_hlaseni.md).

### 40.4.2 Jak RC zapnout
...
> ([§ 40.1.4](#4014-identifikovana-osoba-6g-6l-zdph)), které se RC u EU klienta
> s DIČ zapne automaticky.

RC doklad v cizí měně má vlastní pravidla přepočtu pro výkazy — viz
[§ 36](41_Vykazy_DPH.md#4147-reverse-charge-v-cizi-mene).

## 40.5 Zahraniční fakturace — EU, OSS a třetí země

### 40.5.1 Co aplikace pokrývá
...
### 40.5.2 OSS (One Stop Shop) — co dělá aplikace sama

Režim OSS má **vlastní kapitolu:** [43. Režim OSS (One Stop Shop)](45_OSS.md) —
...
> [§ 43.8.5](45_OSS.md#4595-kde-se-oss-priznani-podava). Před podáním vždy ověř
> sazby, zemi spotřeby, přepočet a výsledné XML s účetní nebo daňovým poradcem.

### 40.5.3 Export mimo EU není reverse charge
...
### 40.5.4 Registrace k DPH ve více zemích
...
## 40.6 Co MyÚčto dělá a co nedělá
...
- **Mzdy** — [úplný mzdový modul](75_Uplne_mzdy.md) (osobní karty, pracovní
  ...
  i jednodušší [Mzdovou rekapitulaci](64_Mzdy.md); úplné mzdy zatím používejte
...
- **Podání na EPO** ve dvou režimech: **přímé podání se ZAREP** (uznávaný
  ...
  formuláře) — viz [93. EPO podání a archiv](49_Archiv_podani_a_rekonciliace.md)
...
### 40.6.2 MyÚčto **nedělá**

- **Produkční mzdy jako jediný zdroj — zatím.** [Mzdový modul](75_Uplne_mzdy.md)
...
→ Pokračuj na [39. Výkazy DPH](41_Vykazy_DPH.md), [43. Režim OSS](45_OSS.md),
