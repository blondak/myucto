...
rekonciliace](93_Archiv_podani_a_rekonciliace.md).
...
[kapitoly Účetní závěrka](91_Uzaverka.md).

## 41.4 Zálohy na daň a pojistné
...
## 41.5 Předfinalizační kontrola („závěrková kontrola účetní")
...
### 41.5.1 Situace, které aplikace v přiznání neumí
...
Ruční seznam nepodporovaných situací z [roční uzávěrky daňové evidence](94_Danova_evidence.md)
se do stejného panelu slévá — nálezy jsou na jednom místě, ne ve dvou seznamech.

## 41.6 Daňová (ne)uznatelnost nákladů (§ 25) — DPPO

Nedaňové náklady se u DPPO poznají podle příznaku **Daňová uznatelnost** na účtu v
[účtovém rozvrhu](84_Ucetni_osnova.md). Šablona rovnou označí jako nedaňové syntetiky
...
## 41.7 Příjem mimo základ daně z příjmů (osvobozený / přefakturace)
...
### 41.7.1 Souvislost se sociálním a zdravotním pojištěním (OSVČ)
...
## 41.8 Opravné a dodatečné přiznání (§ 141 DŘ)
...
### 41.8.1 Kontrola proti skutečně podanému DPPO
...
## 41.9 Roční uzávěrka daňové evidence a snapshot DPFO
...
nový snapshot. Podrobnosti jsou v [Daňové evidenci](94_Danova_evidence.md#9483-rocni-uzaverka-danove-evidence).

## 41.10 Pojistné OSVČ — důležitá omezení
...
## 41.12 Oznámení o příjmech plynoucích do zahraničí a zajištění daně
...
[EPO podání, archív a daňová rekonciliace](93_Archiv_podani_a_rekonciliace.md).
...
### 41.13.1 Co aplikace vědomě nepodporuje

Následující případy nejsou „zatím", ale rozhodnutí. Žádný z nich neprojde tiše — aplikace
je pozná a nález ukáže v panelu [Situace, které aplikace v přiznání neumí](#4151-situace-ktere-aplikace-v-priznani-neumi)
ještě před podáním.
