...
([§ 51](69_Danova_evidence.md): peněžní deník, pohledávky a závazky). Tahle
kapitola je pro režim **podvojné účetnictví** (`double_entry`).

## 42.1 Než začneš — co je „zaúčtováno" a proč na tom všechno stojí
...
- Na detailu vydané faktury ([§ 14](14_Faktury.md)) i přijaté faktury
  ...
  podle [předkontace](67_Ucetni_nastroje.md#673-predkontace)
...
- Když zaúčtování selže, aplikace vrátí srozumitelnou chybu místo tichého
  ...
  a [ochrany účtu při zaúčtování](60_Ucetni_osnova.md#606-ochrany-pri-uctovani).
...
2. **K doúčtování** ([samostatná kapitola](46_Rucni_fronta_doctovani.md))
...
5. **[Automat](45_Automat.md)** — v kokpitu rozlišuj **Zaúčtováno automaticky**,
...
6. **Účetní deník** ([§ 44.2](44_Ucetni_denik.md#442-seznam-zapisu)) — filtr
...
1. Dokonči [**K doúčtování**](46_Rucni_fronta_doctovani.md) a projdi
   [**Úplnost dokladů**](53_Uplnost_dokladu.md). Pohyb bez
...
3. [**Měsíční kontrolu**](54_Mesicni_kontrola.md) spusť
   před DPH a po dokončení měsíce. Výsledek je kontrolní seznam, nikoli automatická
   oprava.
4. **[Saldokonto](52_Saldokonto.md)** — otevřené
...
7. Po skutečném podání nahraj XML a potvrzení do **EPO podání a archívu**.
   ...
   ([§ 44.9 Zámek účtování k datu](44_Ucetni_denik.md#449-zamek-uctovani-k-datu)).
8. **[Měsíční přehled](55_Mesicni_report.md) klientovi**
   — pokud firmu vede externí účetní pro klienta, jedno tlačítko sestaví PDF
   report za měsíc.

## 42.4 Roční cyklus — účetní uzávěrka

Celý postup vede **uzávěrkový průvodce** v [§ 50](66_Uzaverka.md), krok za
krokem:

1. [Předběžné kontroly](66_Uzaverka.md#6621-krok-1-predbezne-kontroly) —
   totéž jako měsíční kontrola, ale za celý rok.
2. [Odpisy majetku](66_Uzaverka.md#6622-krok-2-odpisy-majetku) — hromadné
   zaúčtování ročních odpisů, viz i [§ 49](57_Majetek.md#576-hromadne-zauctovani-odpisu-roku).
3. [Kurzové rozdíly](66_Uzaverka.md#6623-krok-3-kurzove-rozdily) — přecenění
   cizoměnových zůstatků k rozvahovému dni.
4. [Dohadné položky a časové rozlišení](66_Uzaverka.md#6624-kroky-4-5-dohadne-polozky-a-casove-rozliseni),
   včetně návrhů předplacených nákladů a zvolené politiky drobného majetku.
5. [Opravné položky k pohledávkám](66_Uzaverka.md#6625-krok-opravne-polozky-k-pohledavkam) —
   navazuje na saldokonto ze [§ 42.3](#423-mesicni-cyklus).
6. [Daň z příjmů](66_Uzaverka.md#6626-krok-dan-z-prijmu) — mezikrok na
...
8. [Uzavření knih a otevření nového roku](66_Uzaverka.md#663-uzavreni-knih-a-otevreni-noveho-roku).
9. **Uzávěrkový balíček** — před schválením stáhni doložitelný ZIP sestav,
   inventarizací a daňových podkladů.
10. [Schválení závěrky](66_Uzaverka.md#664-interni-kontrola-schvaleni-zaverky-a-znovuotevreni) —
   rozdělení výsledku hospodaření (431 → 428/429/364).

Po celý rok si drž [**Rozvahu**](49_Rozvaha.md) a
[**Výsledovku**](50_Vysledovka_druhova.md)
...
## 42.5 Víc firem — účetní kancelář

Vedeš-li víc firem najednou, sekce Účetnictví začíná položkou
**[Přehled firem](43_Prehled_firem.md)** — cross-firemní pohled na termíny
DPH/KH, nezaúčtované doklady a stav uzávěrky, s prokликem a přepnutím firmy
bez návratu na dashboard.

## 42.6 Mapa kapitol Účetnictví

| Co řešíš | Kapitola |
|---|---|
| Termíny a stav práce napříč firmami | [Přehled firem](43_Prehled_firem.md) |
| Automatické návrhy, schvalování, pravidla a historie | [Automat](45_Automat.md) |
| Zápisy, ruční zápis, storno, zámek k datu | [§ 44 Účetní deník](44_Ucetni_denik.md) |
| Doklady a pohyby, které čekají na ruční rozhodnutí | [K doúčtování](46_Rucni_fronta_doctovani.md) |
| Bankovní pohyby bez podkladu a doklady po splatnosti | [Úplnost dokladů](53_Uplnost_dokladu.md) |
| Průběžná kontrolní brána za měsíc, kvartál či vlastní rozsah | [Měsíční kontrola](54_Mesicni_kontrola.md) |
| Sestavení, PDF a odeslání klientského reportu | [Měsíční přehled](55_Mesicni_report.md) |
| Účtový rozvrh a kontrola účtu | [Účtový rozvrh](60_Ucetni_osnova.md) |
| Předkontace a další servisní nástroje | [Nástroje](67_Ucetni_nastroje.md) |
| Hlavní kniha | [Hlavní kniha](47_Hlavni_kniha.md) |
| Předvaha | [Obratová předvaha](48_Obratova_predvaha.md) |
| Rozvaha | [Rozvaha](49_Rozvaha.md) |
| Výsledovka | [Druhová](50_Vysledovka_druhova.md) a [účelová](51_Vysledovka_ucelova.md) |
| Otevřené pohledávky a závazky | [Saldokonto](52_Saldokonto.md) |
| Měsíční kontroly, úplnost dokladů, K1–K10 a inventarizace | [Účetní kontroly a inventarizace](58_Ucetni_kontroly_a_inventarizace.md) |
| Mzdová rekapitulace, kontace a mzdový list | [Mzdy](56_Mzdy.md) |
| Dlouhodobý i drobný majetek, odpisy, inventární karty | [§ 49 Majetek a odpisy](57_Majetek.md) |
| Uzávěrkový průvodce, kontroly K1–K10, balíček, archiv | [§ 50 Účetní období a uzávěrka](66_Uzaverka.md) |
