# 42. Souhrnné hlášení (DPHSHV)

### 42.1.1 Cesta: `Daně → Souhrnné hlášení`
...
evidenci DPH jako [DPHDP3](39_Vykazy_DPH.md). Rozhoduje DUZP, případně datum vystavení,
...
## 42.5 Náhled a kontrola před exportem
