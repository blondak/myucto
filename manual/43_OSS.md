# 43. Režim OSS (One Stop Shop)

### 43.1.1 Cesta: `Daně → OSS přiznání`
...
[sazby a číselníky](96_Nastaveni.md#9612-sazby-dph) a
[daňový průvodce](38_Fakturujeme.md#385-zahranicni-fakturace-eu-oss-a-treti-zeme).
...
## 43.2 K čemu OSS je a kdy se registrovat

### 43.2.1 Kdy plnění patří do státu spotřeby
...
a vykazuje se v [souhrnném hlášení](42_Souhrnne_hlaseni.md).
...
### 43.2.2 Práh 10 000 EUR (§ 8 odst. 3 ZDPH)
...
### 43.2.3 Sledování prahu v aplikaci
...
### 43.3.1 Zapnutí režimu a platnost registrace
...
### 43.3.2 Sazby DPH pro cizí země — hlídej pole Stát

Aby šla na položku vybrat zahraniční sazba, musí být v číselníku **DPH sazeb**
([§ 96.1.2](96_Nastaveni.md#9612-sazby-dph)) založená — například `PL-23`, `SK-23`,
...
### 43.3.3 Číselník sazeb členských států

**Cesta: `Nastavení → Číselníky → Sazby států OSS`**
([§ 96.1.2b](96_Nastaveni.md#9614-9212b-sazby-statu-oss)).
...
### 43.3.4 Výchozí nastavení na kartě odběratele
...
Vyloučení je přitom bezpečné: pravidlo z [§ 43.3.2](#4342-rozhodovaci-pravidlo)
...
u e-shopu se zbožím — viz [§ 43.9](#4310-na-co-si-dat-pozor).
...
### 43.4.1 Podmínky, které OSS vylučují
...
| Chybí **číselník sazeb členských států** | Nespuštěné migrace — viz [§ 43.2.3](#4333-ciselnik-sazeb-clenskych-statu) |
...
| Karta odběratele **OSS vylučuje** | Viz [§ 43.2.4](#4334-vychozi-nastaveni-na-karte-odberatele) |
...
|---|---|---|---|
| OSS je vyloučené (§ 43.3.1) | tuzemské plnění | **odmítnuto** | **odmítnuto** |
...
### 43.4.3 Co systém odmítne a proč
...
odběratele. Viz [§ 43.9](#4310-na-co-si-dat-pozor).

### 43.4.5 Rozdíly mezi kanály
...
## 43.5 Plnění k ručnímu posouzení
...
### 43.5.1 Dva stavy, které vypadají podobně
...
[§ 43.5](#436-hromadna-editace-oss); výběr **Jen řádky k ručnímu posouzení**
zabírá oba stavy najednou.

### 43.5.3 Doklad rozpadlý mezi obojí
...
### 43.6.1 Dialog a povinný náhled
...
| Sazba řádku v tuzemsku nepotvrzena | Viz [§ 43.5.3](#4363-vypnuti-oss-je-hlidane-stejne-jako-zapnuti) |
...
### 43.6.3 Vypnutí OSS je hlídané stejně jako zapnutí
...
[analytik vstupu, výstupu a zúčtování](84_Ucetni_osnova.md#8432-analytiky-dph-343100-343200-a-343900))
se pak přestane shodovat s tuzemským přiznáním k DPH a OSS daň jiného státu by
navíc vstoupila do [měsíčního zúčtování DPH](84_Ucetni_osnova.md#8433-mesicni-zuctovani-dph).
Přesně kvůli tomu má OSS daň vlastní účet **345.100**.

## 43.9 Přiznání a podání

### 43.9.1 Kvartální náhled
...
kontrolního hlášení i [Knihy DPH](40_Kniha_DPH.md).

### 43.9.2 Přepočet do měny podání
...
### 43.9.5 Kde se OSS přiznání podává
...
> mají — viz
> [kapitola 70](93_Archiv_podani_a_rekonciliace.md#934-asistovane-podani-pres-epo).

### 43.9.6 Archiv podání a rekonciliace
...
**Nástroje → EPO podání a archiv** ([kapitola 70](93_Archiv_podani_a_rekonciliace.md)),
...
1. **hromadná úprava OSS** nad výběrem dokladů ([§ 43.5](#436-hromadna-editace-oss));
...
### 43.10.2 Dobropisy a jejich původní období
...
### 43.10.3 Haléřové rozdíly u množství větší než jedna
...
### 43.10.4 Země spotřeby se bere z odběratele, ne z měny
...
### 43.10.5 Nulová sazba pro odběratele s DIČ
...
[souhrnné hlášení](42_Souhrnne_hlaseni.md) se řídí toutéž klasifikací.

### 43.10.6 Historické doklady z doby před nastavením OSS
...
### 43.10.7 Náhled je poslední kontrolní bod
