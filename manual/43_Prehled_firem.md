...
## 43.1 Které firmy uživatel vidí
...
> otevřete přes [K doúčtování](46_Rucni_fronta_doctovani.md); čekající návrhy
> bankovní kontace jsou v [Automatu](45_Automat.md).

## 43.3 Jak přehled používat
...
Pro denní práci pokračujte kapitolami [Automat](45_Automat.md) a
[K doúčtování](46_Rucni_fronta_doctovani.md), pro periodické kontroly
[Úplnost dokladů](53_Uplnost_dokladu.md) a
[Měsíční kontrola](54_Mesicni_kontrola.md).
