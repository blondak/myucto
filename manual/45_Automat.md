...
## 45.1 Proč je práce s Automatem bezpečná
...
použijte **Stornovat**; podrobnosti jsou v [§ 45.6](#456-vraceni-a-storno-zapisu).
...
> [!TIP]
> Samostatná stránka [**K doúčtování**](46_Rucni_fronta_doctovani.md) ukazuje
...
## 45.5 Schválení, zamítnutí a hromadná práce
...
## 45.7 Průvodce prvním nastavením
...
## 45.10 Jak se Automat učí z oprav
...
## 45.12 Měsíční rutina před uzávěrkou
...
5. otevřít [**Účetnictví → K doúčtování**](46_Rucni_fronta_doctovani.md)
   a dořešit bankovní pohyby bez návrhu,
   nezaúčtované doklady a žádosti o podklady,
6. projít [**Účetnictví → Úplnost dokladů**](53_Uplnost_dokladu.md) v obou směrech,
...
[Úplnost dokladů](53_Uplnost_dokladu.md).

## 45.13 Klávesové zkratky
...
kapitola [Účetní období a uzávěrka](66_Uzaverka.md).
