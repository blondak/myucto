...
### 45.1.1 Cesta: `Daně → OSS přiznání`
...
[daňový průvodce](40_Fakturujeme.md#405-zahranicni-fakturace-eu-oss-a-treti-zeme).
...
## 45.2 K čemu OSS je a kdy se registrovat

### 45.2.1 Kdy plnění patří do státu spotřeby
...
### 45.2.2 Práh 10 000 EUR (§ 8 odst. 3 ZDPH)
...
### 45.2.3 Sledování prahu v aplikaci
...
### 45.3.1 Zapnutí režimu a platnost registrace
...
### 45.3.2 Sazby DPH pro cizí země — hlídej pole Stát
...
### 45.3.3 Číselník sazeb členských států
...
### 45.3.4 Výchozí nastavení na kartě odběratele
...
Vyloučení je přitom bezpečné: pravidlo z [§ 45.3.2](#4542-rozhodovaci-pravidlo)
...
u e-shopu se zbožím — viz [§ 45.9](#4510-na-co-si-dat-pozor).
...
### 45.4.1 Podmínky, které OSS vylučují
...
| Chybí **číselník sazeb členských států** | Nespuštěné migrace — viz [§ 45.2.3](#4533-ciselnik-sazeb-clenskych-statu) |
...
| Karta odběratele **OSS vylučuje** | Viz [§ 45.2.4](#4534-vychozi-nastaveni-na-karte-odberatele) |
...
|---|---|---|---|
| OSS je vyloučené (§ 45.3.1) | tuzemské plnění | **odmítnuto** | **odmítnuto** |
...
### 45.4.3 Co systém odmítne a proč
...
odběratele. Viz [§ 45.9](#4510-na-co-si-dat-pozor).

### 45.4.5 Rozdíly mezi kanály
...
## 45.5 Plnění k ručnímu posouzení
...
### 45.5.1 Dva stavy, které vypadají podobně
...
[§ 45.5](#456-hromadna-editace-oss); výběr **Jen řádky k ručnímu posouzení**
zabírá oba stavy najednou.

### 45.5.3 Doklad rozpadlý mezi obojí
...
### 45.6.1 Dialog a povinný náhled
...
| Sazba řádku v tuzemsku nepotvrzena | Viz [§ 45.5.3](#4563-vypnuti-oss-je-hlidane-stejne-jako-zapnuti) |
...
### 45.6.3 Vypnutí OSS je hlídané stejně jako zapnutí
...
[analytik vstupu, výstupu a zúčtování](66_Ucetni_osnova.md#6632-analytiky-dph-343100-343200-a-343900))
se pak přestane shodovat s tuzemským přiznáním k DPH a OSS daň jiného státu by
navíc vstoupila do [měsíčního zúčtování DPH](66_Ucetni_osnova.md#6633-mesicni-zuctovani-dph).
Přesně kvůli tomu má OSS daň vlastní účet **345.100**.

## 45.9 Přiznání a podání

### 45.9.1 Kvartální náhled
...
### 45.9.5 Kde se OSS přiznání podává
...
> mají — viz
> [kapitola 70](49_Archiv_podani_a_rekonciliace.md#494-asistovane-podani-pres-epo).

### 45.9.6 Archiv podání a rekonciliace
...
1. **hromadná úprava OSS** nad výběrem dokladů ([§ 45.5](#456-hromadna-editace-oss));
...
### 45.10.2 Dobropisy a jejich původní období
...
### 45.10.3 Haléřové rozdíly u množství větší než jedna
...
### 45.10.4 Země spotřeby se bere z odběratele, ne z měny
...
### 45.10.5 Nulová sazba pro odběratele s DIČ
...
### 45.10.6 Historické doklady z doby před nastavením OSS
