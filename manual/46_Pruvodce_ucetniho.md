...
([§ 51](94_Danova_evidence.md): peněžní deník, pohledávky a závazky). Tahle
kapitola je pro režim **podvojné účetnictví** (`double_entry`).

## 46.1 Než začneš — co je „zaúčtováno" a proč na tom všechno stojí
...
- Na detailu vydané faktury ([§ 14](14_Faktury.md)) i přijaté faktury
  ...
  podle [předkontace](92_Ucetni_nastroje.md#923-predkontace)
...
- Když zaúčtování selže, aplikace vrátí srozumitelnou chybu místo tichého
  ...
  a [ochrany účtu při zaúčtování](84_Ucetni_osnova.md#846-ochrany-pri-uctovani).
...
zaúčtování téhož dokladu — viz [Účetní deník](48_Ucetni_denik.md).

### 46.2.1 Čtyři vrstvy, které určují kontaci
...
Podrobně všechny čtyři popisuje kapitola [Šablony a pravidla](83_Sablony.md),
předkontace samotné [§ 92.3](92_Ucetni_nastroje.md#923-predkontace).

> [!TIP]
> Firmě s naimportovanou historií, která ještě žádná pravidla nemá, sestaví
> první sadu **Nástroje → Asistent nastavení účtování**
> ([§ 83.7](83_Sablony.md#837-asistent-nastaveni-uctovani)). Projde existující
...
| **Zařazení, vyřazení a odpis majetku** | zápis odpisu nebo pohybu karty | [§ 49 Majetek](81_Majetek.md) |
...
[Mzdových příkazech a úhradách](68_Platby_a_uhrady.md) a kontroluje na
[Shodě účtování mezd](67_Shoda_uctovani_mezd.md).
...
> ([§ 48.12](48_Ucetni_denik.md#4812-douctovani-nezauctovanych-dokladu)):
...
### 46.2.3 Kde se automatika zapíná a co přesně smí
...
### 46.2.4 Návrhy: co znamená „Proč" a jistota
...
### 46.2.5 Kam výsledek doputuje — tři fronty, tři různé otázky

| Stránka | Odpovídá na otázku | Provádí akce? |
|---|---|---|
| [**Účetnictví → Automat**](49_Automat.md) | Co systém zaúčtoval, co navrhl a co v návrhu potřebuje rozhodnutí? | Ano — schválit, zamítnout, upravit kontaci, odložit, stornovat. |
| [**Účetnictví → K doúčtování**](50_Rucni_fronta_doctovani.md) | Který známý případ nemá hotový zápis a **nevznikl pro něj vůbec žádný návrh**? | Ne — jen odkazuje na zdroj. |
| [**Účetnictví → Úplnost dokladů**](57_Uplnost_dokladu.md) | Které bankovní pohyby nemají doklad a které otevřené doklady jsou po splatnosti? | Ne — kontrolní sestava s agingem. |
...
### 46.2.6 Náklady: od PDF přijaté faktury k účtu
...
### 46.2.7 Bankovní výpisy: od výpisu k zápisu
...
- **Systémová příčina** — po storně vždy oprav i vrstvu z
  [§ 46.2.1](#4621-ctyri-vrstvy-ktere-urcuji-kontaci), jinak stejná chyba vznikne
  příště znovu.
...
2. **K doúčtování** ([samostatná kapitola](50_Rucni_fronta_doctovani.md))
...
5. **[Automat](49_Automat.md)** — v kokpitu rozlišuj **Zaúčtováno dnes**,
...
6. **Účetní deník** ([§ 48.2](48_Ucetni_denik.md#482-seznam-zapisu)) — filtr
...
1. Dokonči [**K doúčtování**](50_Rucni_fronta_doctovani.md) a projdi
   [**Úplnost dokladů**](57_Uplnost_dokladu.md). Pohyb bez
   dokladu není automaticky náklad; vyžádej podklad, nebo účetně dolož, proč je
   zaúčtován bez něj.
2. **Mzdy.** Vede-li firma zjednodušenou
   [Mzdovou rekapitulaci](60_Mzdy.md), zkontroluj zaměstnance, měsíční vstupy a
   náhled předpisu. Vede-li **úplné mzdy**, jdi podle
   [§ 61.3](61_Uplne_mzdy.md#613-doporuceny-mesicni-postup) a výsledek ověř na
   [Shodě účtování mezd](67_Shoda_uctovani_mezd.md). V obou případech odpovídá
   za správnost vstupů, zvláštní režimy a shodu s podklady mzdové agendy účetní.
3. [**Měsíční kontrolu**](58_Mesicni_kontrola.md) spusť
   před DPH a po dokončení měsíce. Výsledek je kontrolní seznam, nikoli automatická
   oprava.
4. **[Saldokonto](56_Saldokonto.md)** — otevřené
...
7. Po skutečném podání nahraj XML a potvrzení do **EPO podání a archívu**.
   ...
   ([§ 48.9 Zámek účtování k datu](48_Ucetni_denik.md#489-zamek-uctovani-k-datu)).
8. **[Měsíční přehled](59_Mesicni_report.md) klientovi**
   — pokud firmu vede externí účetní pro klienta, jedno tlačítko sestaví PDF
   report za měsíc.

## 46.5 Roční cyklus — účetní uzávěrka

Celý postup vede **uzávěrkový průvodce** v [§ 50](91_Uzaverka.md), krok za
krokem:

1. [Předběžné kontroly](91_Uzaverka.md#9121-krok-1-predbezne-kontroly) —
   totéž jako měsíční kontrola, ale za celý rok.
2. [Odpisy majetku](91_Uzaverka.md#9122-krok-2-odpisy-majetku) — hromadné
   zaúčtování ročních odpisů, viz i [§ 49](81_Majetek.md#816-hromadne-zauctovani-odpisu-roku).
3. [Kurzové rozdíly](91_Uzaverka.md#9123-krok-3-kurzove-rozdily) — přecenění
   cizoměnových zůstatků k rozvahovému dni.
4. [Dohadné položky a časové rozlišení](91_Uzaverka.md#9124-kroky-4-5-dohadne-polozky-a-casove-rozliseni),
   ...
   potvrzení.
5. [Opravné položky k pohledávkám](91_Uzaverka.md#9125-krok-opravne-polozky-k-pohledavkam) —
   navazuje na saldokonto ze [§ 46.4](#464-mesicni-cyklus).
6. [Daň z příjmů](91_Uzaverka.md#9126-krok-dan-z-prijmu) — mezikrok na
   [Daň z příjmů](41_Dan_z_prijmu.md).
...
8. [Uzavření knih a otevření nového roku](91_Uzaverka.md#913-uzavreni-knih-a-otevreni-noveho-roku).
9. **Uzávěrkový balíček** — před schválením stáhni doložitelný ZIP sestav,
   inventarizací a daňových podkladů.
10. [Schválení závěrky](91_Uzaverka.md#914-interni-kontrola-schvaleni-zaverky-a-znovuotevreni) —
   rozdělení výsledku hospodaření (431 → 428/429/364).

Po celý rok si drž [**Rozvahu**](53_Rozvaha.md) a
[**Výsledovku**](54_Vysledovka_druhova.md)
...
## 46.6 Víc firem — účetní kancelář

Vedeš-li víc firem najednou, sekce Účetnictví začíná položkou
**[Přehled firem](47_Prehled_firem.md)** — cross-firemní pohled na termíny
...
## 46.7 Mapa kapitol Účetnictví

| Co řešíš | Kapitola |
|---|---|
| Termíny a stav práce napříč firmami | [Přehled firem](47_Prehled_firem.md) |
| Automatické návrhy, schvalování, pravidla a historie | [Automat](49_Automat.md) |
| Zápisy, ruční zápis, storno, zámek k datu | [§ 44 Účetní deník](48_Ucetni_denik.md) |
| Doklady a pohyby, které čekají na ruční rozhodnutí | [K doúčtování](50_Rucni_fronta_doctovani.md) |
| Bankovní pohyby bez podkladu a doklady po splatnosti | [Úplnost dokladů](57_Uplnost_dokladu.md) |
| Průběžná kontrolní brána za měsíc, kvartál či vlastní rozsah | [Měsíční kontrola](58_Mesicni_kontrola.md) |
| Sestavení, PDF a odeslání klientského reportu | [Měsíční přehled](59_Mesicni_report.md) |
| Účtový rozvrh a kontrola účtu | [Účtový rozvrh](84_Ucetni_osnova.md) |
| Předkontace, šablony zápisů, pravidla nákladů a bankovní pravidla | [Šablony a pravidla](83_Sablony.md), [Nástroje](92_Ucetni_nastroje.md) |
| Hlavní kniha | [Hlavní kniha](51_Hlavni_kniha.md) |
| Předvaha | [Obratová předvaha](52_Obratova_predvaha.md) |
| Rozvaha | [Rozvaha](53_Rozvaha.md) |
| Výsledovka | [Druhová](54_Vysledovka_druhova.md) a [účelová](55_Vysledovka_ucelova.md) |
| Otevřené pohledávky a závazky | [Saldokonto](56_Saldokonto.md) |
| Měsíční kontroly, úplnost dokladů, K1–K10 a inventarizace | [Účetní kontroly a inventarizace](82_Ucetni_kontroly_a_inventarizace.md) |
| Mzdová rekapitulace, kontace a mzdový list | [Mzdy](60_Mzdy.md) |
| Úplný mzdový modul a měsíční mzdový běh | [Úplné mzdy](61_Uplne_mzdy.md) |
| Dlouhodobý i drobný majetek, odpisy, inventární karty | [§ 49 Majetek a odpisy](81_Majetek.md) |
| Uzávěrkový průvodce, kontroly K1–K10, balíček, archiv | [§ 50 Účetní období a uzávěrka](91_Uzaverka.md) |
| DPH přiznání, kontrolní hlášení, kniha DPH | [§ 35](39_Vykazy_DPH.md), [§ 36](40_Kniha_DPH.md) |
