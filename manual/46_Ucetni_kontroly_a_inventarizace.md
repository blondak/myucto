...
## 46.2 Doporučená měsíční kontrola

1. Dokonči nebo vysvětli položky v [**K doúčtování**](54_Rucni_fronta_doctovani.md).
2. Otevři [**Účetnictví → Úplnost dokladů**](61_Uplnost_dokladu.md)
   a projdi bankovní pohyby bez dokladu a
   neuhrazené doklady po splatnosti.
3. Spusť [**Účetnictví → Měsíční kontrola**](62_Mesicni_kontrola.md)
...
## 46.5 Inventarizace rozvahových účtů
...
## 46.8 Úplnost číselné řady vydaných dokladů
