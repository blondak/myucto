...
## 47.1 Které firmy uživatel vidí
...
> otevřete přes [K doúčtování](50_Rucni_fronta_doctovani.md); čekající návrhy
> bankovní kontace jsou v [Automatu](49_Automat.md).

## 47.3 Jak přehled používat
...
Pro denní práci pokračujte kapitolami [Automat](49_Automat.md) a
[K doúčtování](50_Rucni_fronta_doctovani.md), pro periodické kontroly
[Úplnost dokladů](57_Uplnost_dokladu.md) a
[Měsíční kontrola](58_Mesicni_kontrola.md).
