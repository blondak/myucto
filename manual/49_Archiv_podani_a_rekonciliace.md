...
### 49.1.1 Filtr, hledání a stránkování
...
### 49.1.2 Kdy jde snapshot smazat
...
## 49.3 Přímé podání přes EPO API
...
### 49.3.1 Jak získat vhodný certifikát
...
### 49.3.2 Zkušební prostředí pro vývoj
...
## 49.4 Asistované podání přes EPO
...
[Měsíční kontrolu](72_Uzaverka.md#727-mesicni-kontrola), pokud to již neprovedlo
řízené workflow firmy.

## 49.5 Rekonciliace proti skutečně podanému XML
...
## 49.6 Řádné, opravné a dodatečné podání
