...
slouží samostatný [Asistent nastavení účtování](83_Sablony.md#837-asistent-nastaveni-uctovani).
...
## 49.1 Proč je práce s Automatem bezpečná
...
použijte **Stornovat**; podrobnosti jsou v [§ 49.6](#496-vraceni-a-storno-zapisu).
...
> [!TIP]
> Samostatná stránka [**K doúčtování**](50_Rucni_fronta_doctovani.md) ukazuje
...
## 49.5 Schválení, zamítnutí a hromadná práce
...
## 49.7 Průvodce prvním nastavením
...
## 49.10 Jak se Automat učí z oprav
...
## 49.12 Měsíční rutina před uzávěrkou
...
5. otevřít [**Účetnictví → K doúčtování**](50_Rucni_fronta_doctovani.md)
   a dořešit bankovní pohyby bez návrhu,
   nezaúčtované doklady a žádosti o podklady,
6. projít [**Účetnictví → Úplnost dokladů**](57_Uplnost_dokladu.md) v obou směrech,
...
[Úplnost dokladů](57_Uplnost_dokladu.md).

## 49.13 Klávesové zkratky
...
kapitola [Účetní období a uzávěrka](91_Uzaverka.md).
