...
- Když zaúčtování selže, aplikace vrátí srozumitelnou chybu místo tichého
  ...
  a [ochrany účtu při zaúčtování](66_Ucetni_osnova.md#666-ochrany-pri-uctovani).
- U banky ([§ 28](30_Bankovni_ucty.md#308-automaticke-zauctovani-bankovnich-transakci-jen-podvojne-ucetnictvi))
  a párovaných plateb ([§ 28.7](29_Banka.md#297-automaticke-zauctovani-sparovanych-plateb-jen-podvojne-ucetnictvi))
  lze zaúčtování z velké části zautomatizovat pravidly — ušetří to ruční
  zaúčtování běžných plateb.

## 50.2 Jak systém účtuje
...
### 50.2.1 Čtyři vrstvy, které určují kontaci
...
předkontace samotné [§ 92.3](73_Ucetni_nastroje.md#733-predkontace).

> [!TIP]
> Firmě s naimportovanou historií, která ještě žádná pravidla nemá, sestaví
> první sadu **Nástroje → Asistent nastavení účtování**
> ([§ 83.7](65_Sablony.md#657-asistent-nastaveni-uctovani)). Projde existující
...
| **Zařazení, vyřazení a odpis majetku** | zápis odpisu nebo pohybu karty | [§ 49 Majetek](28_Majetek.md) |
...
> ([§ 48.12](52_Ucetni_denik.md#5212-douctovani-nezauctovanych-dokladu)):
...
### 50.2.3 Kde se automatika zapíná a co přesně smí
...
### 50.2.4 Návrhy: co znamená „Proč" a jistota
...
### 50.2.5 Kam výsledek doputuje — tři fronty, tři různé otázky
...
### 50.2.6 Náklady: od PDF přijaté faktury k účtu
...
- **Systémová příčina** — po storně vždy oprav i vrstvu z
  [§ 50.2.1](#5021-ctyri-vrstvy-ktere-urcuji-kontaci), jinak stejná chyba vznikne
  příště znovu.
...
4. **Banka** ([§ 27](29_Banka.md)) — potvrď jednoznačná párování, vyřeš
...
5. **[Automat](53_Automat.md)** — v kokpitu rozlišuj **Zaúčtováno dnes**,
...
6. **Účetní deník** ([§ 48.2](52_Ucetni_denik.md#522-seznam-zapisu)) — filtr
...
1. Dokonči [**K doúčtování**](54_Rucni_fronta_doctovani.md) a projdi
   [**Úplnost dokladů**](61_Uplnost_dokladu.md). Pohyb bez
   dokladu není automaticky náklad; vyžádej podklad, nebo účetně dolož, proč je
   zaúčtován bez něj.
2. **Mzdy.** Vede-li firma zjednodušenou
   [Mzdovou rekapitulaci](64_Mzdy.md), zkontroluj zaměstnance, měsíční vstupy a
   náhled předpisu. Vede-li **úplné mzdy**, jdi podle
   [§ 63.3](75_Uplne_mzdy.md#753-doporuceny-mesicni-postup) a výsledek ověř na
   [Shodě účtování mezd](81_Shoda_uctovani_mezd.md). V obou případech odpovídá
   za správnost vstupů, zvláštní režimy a shodu s podklady mzdové agendy účetní.
3. [**Měsíční kontrolu**](62_Mesicni_kontrola.md) spusť
   před DPH a po dokončení měsíce. Výsledek je kontrolní seznam, nikoli automatická
   oprava.
4. **[Saldokonto](60_Saldokonto.md)** — otevřené
...
7. Po skutečném podání nahraj XML a potvrzení do **EPO podání a archívu**.
   ...
   ([§ 48.9 Zámek účtování k datu](52_Ucetni_denik.md#529-zamek-uctovani-k-datu)).
8. **[Měsíční přehled](63_Mesicni_report.md) klientovi**
   — pokud firmu vede externí účetní pro klienta, jedno tlačítko sestaví PDF
   report za měsíc.

## 50.5 Roční cyklus — účetní uzávěrka

Celý postup vede **uzávěrkový průvodce** v [§ 50](72_Uzaverka.md), krok za
krokem:

1. [Předběžné kontroly](72_Uzaverka.md#7221-krok-1-predbezne-kontroly) —
   totéž jako měsíční kontrola, ale za celý rok.
2. [Odpisy majetku](72_Uzaverka.md#7222-krok-2-odpisy-majetku) — hromadné
   zaúčtování ročních odpisů, viz i [§ 49](28_Majetek.md#286-hromadne-zauctovani-odpisu-roku).
3. [Kurzové rozdíly](72_Uzaverka.md#7223-krok-3-kurzove-rozdily) — přecenění
   cizoměnových zůstatků k rozvahovému dni.
4. [Dohadné položky a časové rozlišení](72_Uzaverka.md#7224-kroky-4-5-dohadne-polozky-a-casove-rozliseni),
   ...
   potvrzení.
5. [Opravné položky k pohledávkám](72_Uzaverka.md#7225-krok-opravne-polozky-k-pohledavkam) —
   navazuje na saldokonto ze [§ 50.4](#504-mesicni-cyklus).
6. [Daň z příjmů](72_Uzaverka.md#7226-krok-dan-z-prijmu) — mezikrok na
...
8. [Uzavření knih a otevření nového roku](72_Uzaverka.md#723-uzavreni-knih-a-otevreni-noveho-roku).
9. **Uzávěrkový balíček** — před schválením stáhni doložitelný ZIP sestav,
   inventarizací a daňových podkladů.
10. [Schválení závěrky](72_Uzaverka.md#724-interni-kontrola-schvaleni-zaverky-a-znovuotevreni) —
   rozdělení výsledku hospodaření (431 → 428/429/364).

Po celý rok si drž [**Rozvahu**](57_Rozvaha.md) a
[**Výsledovku**](58_Vysledovka_druhova.md)
...
## 50.6 Víc firem — účetní kancelář
...
| Zápisy, ruční zápis, storno, zámek k datu | [§ 44 Účetní deník](52_Ucetni_denik.md) |
...
| Dlouhodobý i drobný majetek, odpisy, inventární karty | [§ 49 Majetek a odpisy](28_Majetek.md) |
| Uzávěrkový průvodce, kontroly K1–K10, balíček, archiv | [§ 50 Účetní období a uzávěrka](72_Uzaverka.md) |
| DPH přiznání, kontrolní hlášení, kniha DPH | [§ 35](41_Vykazy_DPH.md), [§ 36](42_Kniha_DPH.md) |
| Bankovní a pokladní zaúčtování | [§ 27–29 Peníze](29_Banka.md) |
