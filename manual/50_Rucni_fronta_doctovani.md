...
> návrh v jakémkoli stavu, patří do [Automatu](49_Automat.md). K doúčtování
> odpovídá na otázku „pro co automatika nemá hotový účetní výsledek nebo
> nevytvořila vůbec žádný návrh?“.

## 50.1 Co se do fronty zařazuje

### 50.1.1 Bankovní pohyb bez návrhu
...
### 50.1.2 Nezaúčtovaný vydaný doklad
...
### 50.1.3 Nezaúčtovaný přijatý doklad
...
### 50.1.4 Otevřená žádost o dokument
...
## 50.2 Filtry, pořadí a stránkování
...
## 50.3 Rozdíl proti Automatu a Úplnosti dokladů
...
## 50.4 Doporučený pracovní postup
...
5. Nakonec projděte [Úplnost dokladů](57_Uplnost_dokladu.md), protože může
   najít starý bankovní pohyb bez podkladu i v situaci, kdy K doúčtování působí
   prázdně.

## 50.5 Oprávnění a hranice kontroly
