...
## 51.4 Měsíční rozpad a řádky měsíce
...
prvotní doklad (viz [48.5](#515-opis-uctu)). Zobrazí se prvních 200 řádků;
u delších měsíců odkaz v patičce pokračuje v opisu účtu za stejný měsíc.

Kliknutí na **kód účtu** otevře [kartu účtu](84_Ucetni_osnova.md#847-karta-uctu)
...
[Obratové předvaze](52_Obratova_predvaha.md); výkazové mapování a zákonné
řádky popisuje [Rozvaha](53_Rozvaha.md).
