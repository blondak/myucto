...
slouží samostatný [Asistent nastavení účtování](65_Sablony.md#657-asistent-nastaveni-uctovani).
...
## 53.1 Proč je práce s Automatem bezpečná
...
použijte **Stornovat**; podrobnosti jsou v [§ 53.6](#536-vraceni-a-storno-zapisu).
...
## 53.5 Schválení, zamítnutí a hromadná práce
...
## 53.7 Průvodce prvním nastavením
...
## 53.10 Jak se Automat učí z oprav
...
## 53.12 Měsíční rutina před uzávěrkou
...
5. otevřít [**Účetnictví → K doúčtování**](54_Rucni_fronta_doctovani.md)
   a dořešit bankovní pohyby bez návrhu,
   nezaúčtované doklady a žádosti o podklady,
6. projít [**Účetnictví → Úplnost dokladů**](61_Uplnost_dokladu.md) v obou směrech,
