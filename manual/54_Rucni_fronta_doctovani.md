...
> návrh v jakémkoli stavu, patří do [Automatu](53_Automat.md). K doúčtování
> odpovídá na otázku „pro co automatika nemá hotový účetní výsledek nebo
> nevytvořila vůbec žádný návrh?“.

## 54.1 Co se do fronty zařazuje

### 54.1.1 Bankovní pohyb bez návrhu
...
### 54.1.2 Nezaúčtovaný vydaný doklad
...
### 54.1.3 Nezaúčtovaný přijatý doklad
...
### 54.1.4 Otevřená žádost o dokument
...
## 54.2 Filtry, pořadí a stránkování
...
## 54.3 Rozdíl proti Automatu a Úplnosti dokladů
...
## 54.4 Doporučený pracovní postup
...
5. Nakonec projděte [Úplnost dokladů](61_Uplnost_dokladu.md), protože může
   najít starý bankovní pohyb bez podkladu i v situaci, kdy K doúčtování působí
   prázdně.

## 54.5 Oprávnění a hranice kontroly
