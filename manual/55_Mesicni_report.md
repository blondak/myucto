...
## 55.1 Volba měsíce a rozhodné datum
...
## 55.2 Jak se jednotlivé části počítají
...
## 55.3 Rozdíl mezi náhledem a PDF
...
## 55.6 Doporučený postup před odesláním

1. Dokončete [K doúčtování](46_Rucni_fronta_doctovani.md).
2. Projděte [Úplnost dokladů](53_Uplnost_dokladu.md) a
   [Měsíční kontrolu](54_Mesicni_kontrola.md).
