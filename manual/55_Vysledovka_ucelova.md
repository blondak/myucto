...
## 55.1 Proč je nutná firemní mapa
...
## 55.2 Zdroj, znaménka a společné mapování
...
[druhové výsledovky](54_Vysledovka_druhova.md), pro účelové členění se nastavuje
zvlášť.
...
[druhová výsledovka](54_Vysledovka_druhova.md) daly stejný celkový výsledek;
liší se jen členěním provozních nákladů.

## 55.4 Rozsah, zobrazení a export
