...
## 57.1 Bankovní pohyby bez dokladu
...
## 57.2 Doklady po splatnosti bez plné úhrady
...
načtenou nejstarší část — úplný přehled dá [Saldokonto](56_Saldokonto.md) se
zúženým výběrem.

## 57.3 Doporučený postup
...
6. Po opravách sestavu načtěte znovu a pokračujte
   [Měsíční kontrolou](58_Mesicni_kontrola.md).

## 57.4 Rozdíl proti K doúčtování

[K doúčtování](50_Rucni_fronta_doctovani.md) zahrnuje všechny aktuálně
...
## 57.5 Úplnost číselných řad vydaných dokladů
