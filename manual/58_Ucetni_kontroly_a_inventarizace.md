...
3. Spusť [**Účetnictví → Měsíční kontrola**](54_Mesicni_kontrola.md)
...
- [K doúčtování](46_Rucni_fronta_doctovani.md) je operativní fronta skutečných
  bankovních pohybů bez návrhu, nezaúčtovaných dokladů a otevřených žádostí;
- [Úplnost dokladů](53_Uplnost_dokladu.md) kontroluje bankovní pohyby bez
