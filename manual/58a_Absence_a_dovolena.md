...
Absence se porovnávají s [docházkou a směnami](58b_Dochazka_a_smeny.md) a vstupují do [mzdového běhu](58e_Mzdove_behy.md). Případné výstupy a hlášení popisují [kapitoly 58h](58h_Dokumenty_a_vystupy.md) a [58j](58j_Podani_a_hlaseni.md).
