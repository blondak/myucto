...
### 59.2.1 Zámky po zařazení a potvrzení
...
## 59.3 Detail karty a plán odpisů
...
**⏸** (přerušení §26/8, viz [§ 59.5](#595-preruseni-danoveho-odpisu)).
...
## 59.4 Zařazení do užívání, technické zhodnocení, vyřazení

Akce dostupné v hlavičce detailu se mění podle stavu karty.

### 59.4.1 Zařazení do užívání
...
### 59.4.2 Technické zhodnocení (§33)
...
### 59.4.3 Vyřazení a vrácení vyřazení
...
## 59.5 Přerušení daňového odpisu
...
## 59.6 Hromadné zaúčtování odpisů roku
...
> (viz [Uzávěrka](68_Uzaverka.md)) — po uzavření období už
> zápis pro daný rok zaúčtovat nejde.

## 59.7 Import a export Excelem
...
> odepsáno dosud" ([§ 59.2](#592-zalozeni-a-uprava-karty)), bez nutnosti
...
- **Vrácení vyřazení** funguje, jen dokud je účetní období data vyřazení
  otevřené — po uzávěrce (viz [Uzávěrka](68_Uzaverka.md)) už
