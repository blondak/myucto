...
## 59.1 Volba měsíce a rozhodné datum
...
## 59.2 Jak se jednotlivé části počítají

### 59.2.1 Výsledovka za měsíc
...
### 59.2.3 Pohledávky a závazky po splatnosti
...
## 59.3 Rozdíl mezi náhledem a PDF
...
## 59.6 Doporučený postup před odesláním

1. Dokončete [K doúčtování](50_Rucni_fronta_doctovani.md).
2. Projděte [Úplnost dokladů](57_Uplnost_dokladu.md) a
   [Měsíční kontrolu](58_Mesicni_kontrola.md).
