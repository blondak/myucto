...
popisuje kapitola [Úplné mzdy — rozcestník](61_Uplne_mzdy.md).

## 60.1 Kdy modul použít
...
[Účetním deníku](48_Ucetni_denik.md#484-rucni-zapis).
Obě cesty jsou alternativní; tentýž měsíc nezaúčtovávej dvakrát.

## 60.2 Zaměstnanci a podklady
...
[Zaměstnancích](72_Zamestnanci.md), kde se ukládají šifrovaně. Tyto údaje slouží ročnímu mzdovému
...
### 60.4.1 Automatické měsíční zaúčtování
...
## 60.5 Slevy a měsíční snapshot zaměstnance
...
## 60.7 Zpětné doplnění snapshotů (backfill)
