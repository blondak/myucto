...
část [Co nastavit před první mzdou](#612-co-nastavit-pred-prvni-mzdou). Při běžném
zpracování pokračujte podle části
[Doporučený měsíční postup](#613-doporuceny-mesicni-postup). Podrobné návody jsou
odkazované přímo u jednotlivých kroků.

## 61.1 Jak je mzdový modul uspořádaný
...
## 61.2 Co nastavit před první mzdou
...
### 61.2.1 1. Aktivujte mzdy a určete první období
...
[Mzdové rekapitulaci](60_Mzdy.md). Rozpracovanou aktivaci lze zrušit, dokud je
...
### 61.2.2 2. Doplňte zaměstnavatele a registrace

V [Nastavení mezd](76_Nastaveni_mezd.md) zkontrolujte zejména:
...
- předkontace a účty potřebné pro [zaúčtování mezd](67_Shoda_uctovani_mezd.md);
...
### 61.2.3 3. Nastavte datovou schránku firmy
...
Podrobný postup je v [Podáních a hlášeních](71_Podani_a_hlaseni.md).

### 61.2.4 4. Zkontrolujte legislativní sady

V [Legislativních pravidlech mezd](78_Legislativni_pravidla_mezd.md) ověřte,
...
### 61.2.5 5. Založte zaměstnance a pracovní vztahy

Na kartě [Zaměstnanci](72_Zamestnanci.md) nejprve doplňte osobní,
...
### 61.2.6 6. Připravte mzdové složky a opakované vstupy

V [Mzdových složkách a vstupech](77_Mzdove_slozky_a_vstupy.md) zkontrolujte
...
### 61.2.7 7. Dokončete nastavení firmy
...
## 61.3 Doporučený měsíční postup
...
za ní v [§ 61.3.1](#6131-krok-za-krokem-co-presne-klikat) a hlídá skutečné
pořadí tlačítek v aplikaci.

| Pořadí | Co účetní udělá | Kde pokračovat |
|---:|---|---|
| 1 | Otevře správnou firmu a měsíc, zkontroluje nástupy, výstupy a změny podmínek. | [Zaměstnanci](72_Zamestnanci.md) |
| 2 | Doplní absence, dovolenou, docházku a pracovní cesty a **schválí měsíc docházky**. | [Absence a dovolená](62_Absence_a_dovolena.md), [Docházka a směny](63_Dochazka_a_smeny.md), [Cestovní náhrady](64_Cestovni_nahrady.md) |
| 3 | Zadá mzdy, odměny, náhrady a srážky; pro víc lidí použije hromadný vstup. | [Rychlý měsíční vstup](65_Rychly_mesicni_vstup.md), [Mzdové složky a vstupy](77_Mzdove_slozky_a_vstupy.md) |
| 4 | Založí mzdový běh, uzamkne vstupy a spočítá mzdy; projde blokace i varování. | [Mzdové běhy](66_Mzdove_behy.md) |
| 5 | Zkontroluje čisté mzdy, odvody, daně, rozpad po zaměstnancích, srážky a exekuce. | [Mzdové běhy](66_Mzdove_behy.md), [Srážky a exekuce](74_Srazky_a_exekuce.md) |
| 6 | Schválí revizi. Při chybě opraví zdrojový údaj a vytvoří novou revizi; schválený otisk nepřepisuje. | [Mzdové běhy](66_Mzdove_behy.md) |
| 7 | Zaúčtuje mzdy a porovná mzdovou revizi, deník a platby. | [Shoda účtování mezd](67_Shoda_uctovani_mezd.md) |
| 8 | Připraví závazky, vytvoří mzdové příkazy a po výpisu spáruje skutečné úhrady. | [Mzdové příkazy a úhrady](68_Platby_a_uhrady.md) |
| 9 | Vygeneruje výplatní pásky a měsíční balíček a zkontroluje stav po osobách. | [Dokumenty a výstupy](69_Dokumenty_a_vystupy.md) |
| 10 | Připraví JMHZ a hlášení zdravotním pojišťovnám, zkontroluje XML/PDF, zvolí kanál a každé odeslání výslovně potvrdí; nakonec měsíc uzavře. | [Podání a hlášení](71_Podani_a_hlaseni.md) |

### 61.3.1 Krok za krokem: co přesně klikat
...
Úplný seznam práv modulu je v [§ 61.9](#619-opravneni).

### 61.3.2 Na co si dát pozor
...
[Docházce a směnách](63_Dochazka_a_smeny.md#6393-zakonne-priplatky-ke-mzde-114-az-118).
...
4. zpracujte [roční zúčtování daně](70_Rocni_zuctovani.md) pouze zaměstnancům,
...
6. podejte obě roční
   [vyúčtování daně](71_Podani_a_hlaseni.md#7113-vyuctovani-zalohove-a-srazkove-dane),
   zálohové i srážkové; jsou to dvě samostatná podání s různou lhůtou;
7. projděte [retenční lhůty](79_Retencni_lhuty.md), zákonná zadržení a žádosti
   o [výmaz osobních údajů](80_Vymaz_osobnich_udaju.md). Samotný konec roku
...
## 61.6 Podporovaný rozsah a ruční kontrola
...
kapitole
[Podání a hlášení](71_Podani_a_hlaseni.md#719-storno-a-obsahova-oprava-jmhz).

## 61.7 Kapitoly

1. [Absence a dovolená](62_Absence_a_dovolena.md)
2. [Docházka a směny](63_Dochazka_a_smeny.md)
3. [Cestovní náhrady](64_Cestovni_nahrady.md)
4. [Rychlý měsíční vstup](65_Rychly_mesicni_vstup.md)
5. [Mzdové běhy](66_Mzdove_behy.md)
6. [Shoda účtování mezd](67_Shoda_uctovani_mezd.md)
7. [Mzdové příkazy a úhrady](68_Platby_a_uhrady.md)
8. [Dokumenty a výstupy](69_Dokumenty_a_vystupy.md)
9. [Roční zúčtování](70_Rocni_zuctovani.md)
10. [Podání a hlášení](71_Podani_a_hlaseni.md)
11. [Zaměstnanci](72_Zamestnanci.md)
12. [Dohody o srážkách](73_Dohody_o_srazkach.md)
13. [Srážky a exekuce](74_Srazky_a_exekuce.md)
14. [Koše benefitů](75_Kose_benefitu.md)
15. [Nastavení mezd](76_Nastaveni_mezd.md)
16. [Mzdové složky a vstupy](77_Mzdove_slozky_a_vstupy.md)
17. [Legislativní pravidla mezd](78_Legislativni_pravidla_mezd.md)
18. [Retenční lhůty](79_Retencni_lhuty.md)
19. [Výmaz osobních údajů](80_Vymaz_osobnich_udaju.md)

## 61.8 Společná bezpečnostní pravidla
...
## 61.10 Kde začít při potížích

Nejprve zkontrolujte aktivaci a podporovaný rozsah výše, potom [mzdové běhy](66_Mzdove_behy.md) a [legislativní pravidla](78_Legislativni_pravidla_mezd.md). Obecné diagnostické postupy jsou v kapitole [Řešení problémů](999_Reseni_problemu.md).
