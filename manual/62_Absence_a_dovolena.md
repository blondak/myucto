...
Absence se porovnávají s [docházkou a směnami](63_Dochazka_a_smeny.md) a vstupují do [mzdového běhu](66_Mzdove_behy.md). Případné výstupy a hlášení popisují [kapitoly 58h](69_Dokumenty_a_vystupy.md) a [58j](71_Podani_a_hlaseni.md).
...
### 62.8.1 Hromadný výpočet nároku
...
> neexistuje — viz [Legislativní pravidla mezd](78_Legislativni_pravidla_mezd.md#7881-ktere-roky-jsou-pokryte).
