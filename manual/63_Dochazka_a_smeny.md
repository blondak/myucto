...
## 63.4 Import docházky z CSV nebo XLSX
...
### 63.4.1 Bezpečnost a limity XLSX
...
Nepřítomnosti patří do [absencí](62_Absence_a_dovolena.md), jednorázové odměny do [rychlého vstupu](65_Rychly_mesicni_vstup.md) a výsledný čas do [mzdových běhů](66_Mzdove_behy.md).



## 63.9 Podrobný pracovní postup a kontroly

### 63.9.1 Limity práce přesčas
...
### 63.9.2 Náhradní volno za přesčas
...
### 63.9.3 Zákonné příplatky ke mzdě (§ 114 až § 118)
