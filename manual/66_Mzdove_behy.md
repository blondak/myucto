...
[shodu účtování](67_Shoda_uctovani_mezd.md) → **Připravit platby** a vypořádat
[mzdové příkazy a úhrady](68_Platby_a_uhrady.md) → vydat
[dokumenty](69_Dokumenty_a_vystupy.md) → odeslat [podání](71_Podani_a_hlaseni.md).
Teprve potom měsíc **Uzavřít**. Celý klikací postup je v
[§ 61.3.1](61_Uplne_mzdy.md#6131-krok-za-krokem-co-presne-klikat).
