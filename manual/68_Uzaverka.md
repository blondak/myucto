...
## 68.1 Účetní období — přehled a stavy
...
| **Uzavírá se** (`closing`) | Probíhá uzávěrkový průvodce (viz [§ 68.2](#682-uzaverkovy-pruvodce-zahajeni-a-kroky)). |
...
- **Znovuotevřít** (`closed → open`) — vyžaduje **důvod** (min. 10 znaků).
  ...
  *Uzavření knih* (viz [§ 68.3](#683-uzavreni-knih-a-otevreni-noveho-roku)).
...
## 68.2 Uzávěrkový průvodce — zahájení a kroky
...
| 8 | **Zásoby** | `stock` | ✗ | **podmíněný** — jen firma se skladem účtovaným způsobem B; jinak automaticky `skipped` (viz [§ 68.2.7](#6827-backendovy-krok-zasoby)) |
...
### 68.2.4 Kroky 4–5 — Dohadné položky a časové rozlišení
...
### 68.2.5 Krok — Opravné položky k pohledávkám
...
## 68.3 Uzavření knih a otevření nového roku
...
### 68.4.1 Rozdělení výsledku hospodaření (431 → 428 / 429 / 364)
...
- **Storno přecenění saldokonta k 1. dni nového období** — řídí, zda krok *Otevření
  nového roku* zaúčtuje i zrcadlové storno kurzových rozdílů (viz [§ 68.3](#683-uzavreni-knih-a-otevreni-noveho-roku)).
...
## 68.7 Měsíční kontrola

Praktické pořadí kontrol, inventarizaci rozvahových účtů a společnou interpretaci
K1–K10 shrnuje samostatná kapitola
[Účetní kontroly a inventarizace](60_Ucetni_kontroly_a_inventarizace.md).

Uzávěrkové kontroly z [kroku 1](#6821-krok-1-predbezne-kontroly) nemusíš čekat až na
...
### 68.7.1 Kontrolní mapa K1–K10 a její interpretace
