...
Dočasný odkaz vrácený EPO má krátkou platnost. Server jej neukládá do databáze
ani logu; pouze aktuální prohlížeč si jej ponechá do času expirace. Formulář lze
proto po obnovení stránky nebo opětovném otevření MyÚčta obnovit přes
**Pokračovat do EPO**. Po vypršení použij **Vytvořit nový odkaz EPO**;
dosavadní aktivní pokus se v historii označí jako zrušený a vznikne nový.
