...
mezi kterými se přepíná v nastavení dodavatele (viz [Multi_supplier](72_Multi_supplier.md)).
...
> (viz [§ 71.6](#716-nezarazene-pohyby-a-varovani)).
...
## 71.1 Zapnutí režimu a dostupnost v menu
...
[Multi_supplier](72_Multi_supplier.md)). Podle aktuálně zvoleného režimu se v hlavním
...
## 71.2 Peněžní deník — filtry a rozsah
...
## 71.3 Souhrn (počáteční a konečný zůstatek, totály)
...
| Nezařazeno | *(zobrazí se jen když existuje)* — pohyby čekající na zařazení, viz § 71.6 |
...
| Klasifikace | Barevný štítek s daňovým zařazením (viz § 71.5) |
...
## 71.5 Daňová klasifikace pohybů
...
| **Nezařazeno** | Pohyb, který systém nedokázal automaticky zařadit — viz § 71.6 |
...
## 71.6 Nezařazené pohyby a varování
...
## 71.7 Kontrola vůči přiznanému příjmu
...
### 71.8.2 Tabulky pohledávek a závazků
...
### 71.8.3 Roční uzávěrka daňové evidence
...
## 71.9 Návaznost na ostatní moduly
...
- **Více dodavatelů** ([§ 52](72_Multi_supplier.md)) — režim účetnictví (daňová
...
## 71.10 Přechodový můstek mezi evidencí a účetnictvím (přílohy č. 2 a 3 ZDP)

Když se firma vedená v daňové evidenci rozhodne přejít na **podvojné účetnictví**
(změna režimu, viz [§ 72.6.1](72_Multi_supplier.md)), nejde jen o
...
### 71.10.1 Co se do úpravy počítá
...
### 71.10.2 Co systém nabízí — podklady pro přechod
...
### 71.10.3 Průvodce aktivací podvojného účetnictví
...
- Sestavy jsou z většiny **read-only** — v peněžním deníku ani v přehledu
  ...
  pokladních pohybů bez navázaného dokladu ([§ 71.6](#716-nezarazene-pohyby-a-varovani))
