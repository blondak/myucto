...
## 71.2.1 Měsíční přehled — co následuje
...
odesílací kanál nemá. Které agendy aplikace odesílá sama, popisuje § 71.8 a dál.
...
kapitola
[Datová schránka](98_Datova_schranka.md#9842-odeslani-primo-z-aplikace-v-relaci-mobilniho-klice).
...
evidenci osoby (viz [Zaměstnanci](72_Zamestnanci.md#7282-zakonna-evidence-osoby)).
...
Identifikátory nastavte v [Nastavení mezd](76_Nastaveni_mezd.md). Firemní přístupy, ruční inbox a odchozí zprávy popisuje kapitola [Datová schránka](98_Datova_schranka.md), globální registraci pro odesílání správcem systému pak [Odesílací brána ISDS](99_Odesilaci_brana_ISDS.md). Zdrojová data pocházejí z [mzdového běhu](66_Mzdove_behy.md); kontrolní soubory a doručenky uchovávejte podle [retenčních lhůt](79_Retencni_lhuty.md).



## 71.8 Podrobný tok podání
...
### 71.8.1 Registrace zaměstnance PREZEC a REGZEC
...
[Podání zdravotním pojišťovnám](#7111-podani-zdravotnim-pojistovnam).
...
### 71.8.2 Hlášení změn do registru pojištěnců (A3)
...
## 71.9 Storno a obsahová oprava JMHZ
...
## 71.10 Evidenční list důchodového pojištění
...
## 71.11 Podání zdravotním pojišťovnám
...
## 71.12 Nemocenské a další zákonné povinnosti
...
## 71.13 Vyúčtování zálohové a srážkové daně
...
## 71.14 Žádost o poukázání chybějící částky na daňovém bonusu
...
[Vyúčtováním daně](#7113-vyuctovani-zalohove-a-srazkove-dane) nemá žádost
