...
[Nástroje](73_Ucetni_nastroje.md#736-obnovitelny-archiv-v-kompletnim-exportu).
...
## 72.1 Účetní období — přehled a stavy
...
### 72.1.1 Automaticky doplněná období
...
| **Uzavírá se** (`closing`) | Probíhá uzávěrkový průvodce (viz [§ 72.2](#722-uzaverkovy-pruvodce-zahajeni-a-kroky)). |
...
- **Znovuotevřít** (`closed → open`) — vyžaduje **důvod** (min. 10 znaků).
  ...
  *Uzavření knih* (viz [§ 72.3](#723-uzavreni-knih-a-otevreni-noveho-roku)).
...
> Podrobně viz [Účetní deník § 44.9 Zámek účtování k datu](52_Ucetni_denik.md).

## 72.2 Uzávěrkový průvodce — zahájení a kroky
...
| 8 | **Zásoby** | `stock` | ✗ | **podmíněný** — jen firma se skladem účtovaným způsobem B; jinak automaticky `skipped` (viz [§ 72.2.7](#7227-backendovy-krok-zasoby)) |
...
### 72.2.1 Krok 1 — Předběžné kontroly
...
- **mezičlen plateb kartou** (378.x): zůstatek každé analytiky karty proti
  ...
  vysvětlit nejde (viz [Platební karty](31_Platebni_karty.md#3174-kontroly));
...
### 72.2.4 Kroky 4–5 — Dohadné položky a časové rozlišení
...
### 72.2.5 Krok — Opravné položky k pohledávkám
...
Doklad dostane číslo z řady **UZ** (viz [§ 72.5](#725-ciselne-rady-dokladu-uzaverky)).
...
### 72.3.2 Krok — Otevření nového roku
...
nového období"** (viz [§ 72.5](#725-ciselne-rady-dokladu-uzaverky)), zaúčtuje se
...
## 72.4 Interní kontrola, schválení závěrky a znovuotevření

Jakmile je krok *Uzavření knih* hotový, období je ve stavu **Uzavřené** a je možné
kroky ještě revidovat (revert) nebo období znovuotevřít (viz [§ 72.1](#721-ucetni-obdobi-prehled-a-stavy)).
...
### 72.4.1 Rozdělení výsledku hospodaření (431 → 428 / 429 / 364)
...
## 72.5 Číselné řady dokladů uzávěrky
...
### 72.5.1 Nastavení uzávěrky a výkazů
...
- **Storno přecenění saldokonta k 1. dni nového období** — řídí, zda krok *Otevření
  nového roku* zaúčtuje i zrcadlové storno kurzových rozdílů (viz [§ 72.3](#723-uzavreni-knih-a-otevreni-noveho-roku)).
...
> přiznání** v [§ 72.7.1](#7271-kontrolni-mapa-k1-k10-a-jeji-interpretace)). Případné
...
Uzávěrkové kontroly z [kroku 1](#7221-krok-1-predbezne-kontroly) nemusíš čekat až na
...
- **Saldo 343 vs. přiznání DPH** — porovná zaúčtovaný obrat účtu **343** s daní
  ...
  34](41_Vykazy_DPH.md)); dává smysl jen když je zvolený rozsah přesně jeden kalendářní
...
- **DUZP proti příloze** (varování) — doklady, u kterých AI vyčetla z přílohy DUZP
  ...
  v kapitole [Připojení skenů k dokladům](35_Pripojeni_skenu.md#355-rozpory-dokladu-s-prilohami).
...
**Zámek k datu.** Nahoře na stránce vidíš aktuální stav [zámku účtování k datu](52_Ucetni_denik.md#529-zamek-uctovani-k-datu)
...
### 72.7.1 Kontrolní mapa K1–K10 a její interpretace
