...
- **Dodavatelé** — viz [72. Multi-supplier](72_Multi_supplier.md)
...
### 73.1.2a OSS a daňové nastavení
...
vedle v [Sazbách DPH](#7312-sazby-dph). Rozdíl je podstatný: sazby DPH si zakládáš ty
...
vždy. Podrobnosti jsou v [76. Bezpečnost](76_Bezpecnost.md).

## 73.4 E-mailové šablony
...
> [Retence a právní zadržení](69_Ucetni_nastroje.md#697-retence-a-pravni-zadrzeni-na-backendu)).

## 73.6 Elektronické podpisy
...
## 73.7 Odesílací e-mailové profily
...
firmy](72_Multi_supplier.md) se nabídka filtrů načte znovu pro nově zvolenou
firmu. Sloupce, hustota a řazení (viz [§ 73.9.3](#7393-sloupce-hustota-radku-a-razeni))
...
### 73.9.3 Sloupce, hustota řádků a řazení
...
### 73.9.4 Omezení a technické poznámky
...
## 73.11 Automatické zaúčtování při vystavení/přijetí dokladu
...
## 73.14 Systém → Sazby a číselníky
...
[Daňové konstanty](75_Danove_konstanty.md).

## 73.15 E-maily → Odeslané
