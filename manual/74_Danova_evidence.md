...
(deník, hlavní kniha, rozvaha, výsledovka) popsané v [§ 44 a násl.](52_Ucetni_denik.md).
...
> (viz [§ 74.6](#746-nezarazene-pohyby-a-varovani)).
...
proto samo nesmí změnit výsledek DPH. Viz [Výkazy DPH](41_Vykazy_DPH.md).

## 74.1 Zapnutí režimu a dostupnost v menu
...
> doklady (PPD/VPD) — viz [Pokladna](32_Pokladna.md). V daňové evidenci ale doklad
...
## 74.2 Peněžní deník — filtry a rozsah
...
## 74.3 Souhrn (počáteční a konečný zůstatek, totály)
...
| Nezařazeno | *(zobrazí se jen když existuje)* — pohyby čekající na zařazení, viz § 74.6 |
...
[kapitole Daň z příjmů](43_Dan_z_prijmu.md#432-jak-se-pocita-dpfo).
...
| Klasifikace | Barevný štítek s daňovým zařazením (viz § 74.5) |
...
## 74.5 Daňová klasifikace pohybů
...
| **Nezařazeno** | Pohyb, který systém nedokázal automaticky zařadit — viz § 74.6 |
...
> Ostatní — viz [§ 31.3.2 Účel dokladu](32_Pokladna.md#3232-ucel-dokladu)).
...
## 74.6 Nezařazené pohyby a varování
...
## 74.7 Kontrola vůči přiznanému příjmu
...
### 74.8.2 Tabulky pohledávek a závazků
...
[§ 26](26_Platebni_prikazy.md) a [§ 31.3.2](32_Pokladna.md#3232-ucel-dokladu)).
...
### 74.8.3 Roční uzávěrka daňové evidence
...
## 74.9 Návaznost na ostatní moduly

- **Pokladna** ([§ 29](32_Pokladna.md)) — jediné místo, kde v režimu daňové
...
- **Daň z příjmů (DPFO)** ([samostatná kapitola](43_Dan_z_prijmu.md)) — u OSVČ v režimu daňové
...
## 74.10 Přechodový můstek mezi evidencí a účetnictvím (přílohy č. 2 a 3 ZDP)
...
### 74.10.1 Co se do úpravy počítá
...
### 74.10.2 Co systém nabízí — podklady pro přechod
...
> (viz [Daň z příjmů](43_Dan_z_prijmu.md)).
...
### 74.10.3 Průvodce aktivací podvojného účetnictví
...
- Sestavy jsou z většiny **read-only** — v peněžním deníku ani v přehledu
  ...
  pokladních pohybů bez navázaného dokladu ([§ 74.6](#746-nezarazene-pohyby-a-varovani))
