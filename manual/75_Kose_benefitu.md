...
Význam mzdového dopadu nastavují [složky](77_Mzdove_slozky_a_vstupy.md), měsíční hodnotu lze zkontrolovat v [rychlém vstupu](65_Rychly_mesicni_vstup.md) a vypočtený výsledek v [mzdovém běhu](66_Mzdove_behy.md).



## 75.8 Podrobný pracovní postup a kontroly

### 75.8.1 Roční koš osvobození benefitů
...
[Shoda účtování mezd](67_Shoda_uctovani_mezd.md#6781-ucetne-neutralni-nepenezni-plneni).
