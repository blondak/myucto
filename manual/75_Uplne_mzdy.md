...
část [Co nastavit před první mzdou](#752-co-nastavit-pred-prvni-mzdou). Při běžném
zpracování pokračujte podle části
[Doporučený měsíční postup](#753-doporuceny-mesicni-postup). Podrobné návody jsou
odkazované přímo u jednotlivých kroků.

## 75.1 Jak je mzdový modul uspořádaný
...
## 75.2 Co nastavit před první mzdou
...
### 75.2.1 1. Aktivujte mzdy a určete první období
...
[Mzdové rekapitulaci](64_Mzdy.md). Rozpracovanou aktivaci lze zrušit, dokud je
...
### 75.2.2 2. Doplňte zaměstnavatele a registrace

V [Nastavení mezd](90_Nastaveni_mezd.md) zkontrolujte zejména:
...
- předkontace a účty potřebné pro [zaúčtování mezd](81_Shoda_uctovani_mezd.md);
...
### 75.2.3 3. Nastavte datovou schránku firmy
...
Podrobný postup je v [Podáních a hlášeních](85_Podani_a_hlaseni.md).

### 75.2.4 4. Zkontrolujte legislativní sady

V [Legislativních pravidlech mezd](92_Legislativni_pravidla_mezd.md) ověřte,
...
### 75.2.5 5. Založte zaměstnance a pracovní vztahy

Na kartě [Zaměstnanci](86_Zamestnanci.md) nejprve doplňte osobní,
...
### 75.2.6 6. Připravte mzdové složky a opakované vstupy

V [Mzdových složkách a vstupech](91_Mzdove_slozky_a_vstupy.md) zkontrolujte
...
### 75.2.7 7. Dokončete nastavení firmy
...
za ní v [§ 75.3.1](#7531-krok-za-krokem-co-presne-klikat) a hlídá skutečné
pořadí tlačítek v aplikaci.

| Pořadí | Co účetní udělá | Kde pokračovat |
|---:|---|---|
| 1 | Otevře správnou firmu a měsíc, zkontroluje nástupy, výstupy a změny podmínek. | [Zaměstnanci](86_Zamestnanci.md) |
| 2 | Doplní absence, dovolenou, docházku a pracovní cesty a **schválí měsíc docházky**. | [Absence a dovolená](76_Absence_a_dovolena.md), [Docházka a směny](77_Dochazka_a_smeny.md), [Cestovní náhrady](78_Cestovni_nahrady.md) |
| 3 | Zadá mzdy, odměny, náhrady a srážky; pro víc lidí použije hromadný vstup. | [Rychlý měsíční vstup](79_Rychly_mesicni_vstup.md), [Mzdové složky a vstupy](91_Mzdove_slozky_a_vstupy.md) |
| 4 | Založí mzdový běh, uzamkne vstupy a spočítá mzdy; projde blokace i varování. | [Mzdové běhy](80_Mzdove_behy.md) |
| 5 | Zkontroluje čisté mzdy, odvody, daně, rozpad po zaměstnancích, srážky a exekuce. | [Mzdové běhy](80_Mzdove_behy.md), [Srážky a exekuce](88_Srazky_a_exekuce.md) |
| 6 | Schválí revizi. Při chybě opraví zdrojový údaj a vytvoří novou revizi; schválený otisk nepřepisuje. | [Mzdové běhy](80_Mzdove_behy.md) |
| 7 | Zaúčtuje mzdy a porovná mzdovou revizi, deník a platby. | [Shoda účtování mezd](81_Shoda_uctovani_mezd.md) |
| 8 | Připraví závazky, vytvoří mzdové příkazy a po výpisu spáruje skutečné úhrady. | [Mzdové příkazy a úhrady](82_Platby_a_uhrady.md) |
| 9 | Vygeneruje výplatní pásky a měsíční balíček a zkontroluje stav po osobách. | [Dokumenty a výstupy](83_Dokumenty_a_vystupy.md) |
| 10 | Připraví JMHZ a hlášení zdravotním pojišťovnám, zkontroluje XML/PDF, zvolí kanál a každé odeslání výslovně potvrdí; nakonec měsíc uzavře. | [Podání a hlášení](85_Podani_a_hlaseni.md) |

### 75.3.1 Krok za krokem: co přesně klikat
...
Úplný seznam práv modulu je v [§ 75.9](#759-opravneni).

### 75.3.2 Na co si dát pozor
...
[Docházce a směnách](77_Dochazka_a_smeny.md#7793-zakonne-priplatky-ke-mzde-114-az-118).
...
4. zpracujte [roční zúčtování daně](84_Rocni_zuctovani.md) pouze zaměstnancům,
...
## 75.6 Podporovaný rozsah a ruční kontrola
...
11. [Zaměstnanci](86_Zamestnanci.md)
12. [Dohody o srážkách](87_Dohody_o_srazkach.md)
13. [Srážky a exekuce](88_Srazky_a_exekuce.md)
14. [Koše benefitů](89_Kose_benefitu.md)
15. [Nastavení mezd](90_Nastaveni_mezd.md)
16. [Mzdové složky a vstupy](91_Mzdove_slozky_a_vstupy.md)
...
## 75.10 Kde začít při potížích

Nejprve zkontrolujte aktivaci a podporovaný rozsah výše, potom [mzdové běhy](80_Mzdove_behy.md) a [legislativní pravidla](92_Legislativni_pravidla_mezd.md). Obecné diagnostické postupy jsou v kapitole [Řešení problémů](999_Reseni_problemu.md).
