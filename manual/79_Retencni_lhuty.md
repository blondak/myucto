...
Fyzický proces popisuje [výmaz osobních údajů](80_Vymaz_osobnich_udaju.md). Uchovávané výstupy vznikají v [dokumentech](69_Dokumenty_a_vystupy.md) a [podáních](71_Podani_a_hlaseni.md).
...
([Výmaz osobních údajů](80_Vymaz_osobnich_udaju.md)).
...
### 79.8.2 Co z lhůt plyne pro výmaz
...
### 79.8.3 Odchylka firmy od katalogové lhůty
...
### 79.8.4 Zadržení výmazu (legal hold)
