...
### 81.2.1 Zámky po zařazení a potvrzení
...
## 81.3 Detail karty a plán odpisů
...
**⏸** (přerušení §26/8, viz [§ 81.5](#815-preruseni-danoveho-odpisu)).
...
## 81.4 Zařazení do užívání, technické zhodnocení, vyřazení

Akce dostupné v hlavičce detailu se mění podle stavu karty.

### 81.4.1 Zařazení do užívání
...
### 81.4.2 Technické zhodnocení (§33)
...
### 81.4.3 Vyřazení a vrácení vyřazení
...
## 81.5 Přerušení daňového odpisu
...
## 81.6 Hromadné zaúčtování odpisů roku
...
- zaúčtuje **účetní odpis roku** (MD nákladový účet z kontace
  ...
  odpovídající řádek do [Účetního deníku](48_Ucetni_denik.md) se zdrojem
  „odpis" — přes [PostingService](48_Ucetni_denik.md) se stejnou
...
> (viz [Uzávěrka](91_Uzaverka.md)) — po uzavření období už
> zápis pro daný rok zaúčtovat nejde.

## 81.7 Import a export Excelem
...
> odepsáno dosud" ([§ 81.2](#812-zalozeni-a-uprava-karty)), bez nutnosti
...
- **Vrácení vyřazení** funguje, jen dokud je účetní období data vyřazení
  otevřené — po uzávěrce (viz [Uzávěrka](91_Uzaverka.md)) už
