# 82. Účetní kontroly a inventarizace
...
## 82.1 Tři vrstvy kontroly

1. **Provozní úplnost** — [K doúčtování](50_Rucni_fronta_doctovani.md)
   a [Úplnost dokladů](57_Uplnost_dokladu.md) hledají známé položky bez
...
## 82.2 Doporučená měsíční kontrola

1. Dokonči nebo vysvětli položky v [**K doúčtování**](50_Rucni_fronta_doctovani.md).
2. Otevři [**Účetnictví → Úplnost dokladů**](57_Uplnost_dokladu.md)
   a projdi bankovní pohyby bez dokladu a
   neuhrazené doklady po splatnosti.
3. Spusť [**Účetnictví → Měsíční kontrola**](58_Mesicni_kontrola.md)
...
## 82.3 Provozní úplnost dokladů

Podrobný popis obou pracovních pohledů je rozdělený podle bodů menu:

- [K doúčtování](50_Rucni_fronta_doctovani.md) je operativní fronta skutečných
  bankovních pohybů bez návrhu, nezaúčtovaných dokladů a otevřených žádostí;
- [Úplnost dokladů](57_Uplnost_dokladu.md) kontroluje bankovní pohyby bez
...
## 82.4 Audit párování plateb

[Měsíční kontrola](58_Mesicni_kontrola.md) porovnává stav úhrad, vazby
...
## 82.5 Inventarizace rozvahových účtů
...
v kapitole [Měsíční kontrola](58_Mesicni_kontrola.md).

## 82.7 Audit kurzů ČNB
...
## 82.8 Úplnost číselné řady vydaných dokladů
...
## 82.9 Vazba na uzávěrku a balíček
