...
rozdělení menu popsány samostatně v kapitole [Nástroje](92_Ucetni_nastroje.md);
šablony zápisů a pravidla nákladů v kapitole
[Šablony](83_Sablony.md).

## 84.1 Co stránka zobrazuje
...
## 84.2 Automatické založení osnovy
...
343.900** — viz [§ 84.3.2](#8432-analytiky-dph-343100-343200-a-343900), a nedaňové
...
[Aktivace účetnictví](86_Aktivace_ucetnictvi.md).
...
## 84.3 Syntetické a analytické účty
...
### 84.3.1 Tečkovaný zápis analytik
...
### 84.3.2 Analytiky DPH 343.100, 343.200 a 343.900
...
| **343.900** | Daň z přidané hodnoty **zúčtování** | jen dvě věci: měsíční doklad zúčtování (§ 84.3.3) a **platba nebo vratka finančnímu úřadu** z banky |
...
> vzájemně vynetují a firmu **přeskočí měsíční zúčtování DPH** (§ 84.3.3).
...
> 7 ZDPH — to je pořád ruční zápis (viz [§ 36](39_Vykazy_DPH.md)).

## 84.4 Aktivace a deaktivace
...
- **počáteční stav, obrat MD, obrat Dal a konečný zůstatek** za zvolený rozsah;
  počítají se stejně jako v [Hlavní knize](51_Hlavni_kniha.md) a v opisu účtu,
...
v hlavičce vedou na [Opis účtu](51_Hlavni_kniha.md#515-opis-uctu), do
[Hlavní knihy](51_Hlavni_kniha.md) (kniha účet sama rozbalí) a do
[Účetního deníku](48_Ucetni_denik.md) filtrovaného na tento účet a rozsah;
u syntetiky pokrývá filtr i její analytiky.

Karta je jen ke čtení — název a aktivitu se mění v seznamu účtů.

## 84.8 Oprávnění a chyby
