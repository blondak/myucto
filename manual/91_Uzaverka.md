...
[Nástroje](92_Ucetni_nastroje.md#926-obnovitelny-archiv-v-kompletnim-exportu).
...
## 91.1 Účetní období — přehled a stavy
...
### 91.1.1 Automaticky doplněná období
...
| **Uzavírá se** (`closing`) | Probíhá uzávěrkový průvodce (viz [§ 91.2](#912-uzaverkovy-pruvodce-zahajeni-a-kroky)). |
...
- **Znovuotevřít** (`closed → open`) — vyžaduje **důvod** (min. 10 znaků).
  ...
  *Uzavření knih* (viz [§ 91.3](#913-uzavreni-knih-a-otevreni-noveho-roku)).
...
> Podrobně viz [Účetní deník § 44.9 Zámek účtování k datu](48_Ucetni_denik.md).

## 91.2 Uzávěrkový průvodce — zahájení a kroky
...
| 8 | **Zásoby** | `stock` | ✗ | **podmíněný** — jen firma se skladem účtovaným způsobem B; jinak automaticky `skipped` (viz [§ 91.2.7](#9127-backendovy-krok-zasoby)) |
...
### 91.2.1 Krok 1 — Předběžné kontroly
...
- **mezičlen plateb kartou** (378.x): zůstatek každé analytiky karty proti
  ...
  vysvětlit nejde (viz [Platební karty](97_Platebni_karty.md#kontroly));
...
> uzávěrky, jak je popsáno v [Majetek § 59.6](81_Majetek.md).

### 91.2.3 Krok 3 — Kurzové rozdíly
...
### 91.2.4 Kroky 4–5 — Dohadné položky a časové rozlišení
...
### 91.2.5 Krok — Opravné položky k pohledávkám
...
## 91.3 Uzavření knih a otevření nového roku

### 91.3.1 Krok — Uzavření knih
...
Doklad dostane číslo z řady **UZ** (viz [§ 91.5](#915-ciselne-rady-dokladu-uzaverky)).
...
### 91.3.2 Krok — Otevření nového roku
...
nového období"** (viz [§ 91.5](#915-ciselne-rady-dokladu-uzaverky)), zaúčtuje se
...
## 91.4 Interní kontrola, schválení závěrky a znovuotevření

Jakmile je krok *Uzavření knih* hotový, období je ve stavu **Uzavřené** a je možné
kroky ještě revidovat (revert) nebo období znovuotevřít (viz [§ 91.1](#911-ucetni-obdobi-prehled-a-stavy)).
...
### 91.4.1 Rozdělení výsledku hospodaření (431 → 428 / 429 / 364)
...
## 91.5 Číselné řady dokladů uzávěrky
...
### 91.5.1 Nastavení uzávěrky a výkazů
...
- **Storno přecenění saldokonta k 1. dni nového období** — řídí, zda krok *Otevření
  nového roku* zaúčtuje i zrcadlové storno kurzových rozdílů (viz [§ 91.3](#913-uzavreni-knih-a-otevreni-noveho-roku)).
...
> přiznání** v [§ 91.7.1](#9171-kontrolni-mapa-k1-k10-a-jeji-interpretace)). Případné
...
## 91.7 Měsíční kontrola

Praktické pořadí kontrol, inventarizaci rozvahových účtů a společnou interpretaci
K1–K10 shrnuje samostatná kapitola
[Účetní kontroly a inventarizace](82_Ucetni_kontroly_a_inventarizace.md).

Uzávěrkové kontroly z [kroku 1](#9121-krok-1-predbezne-kontroly) nemusíš čekat až na
...
- **Saldo 343 vs. přiznání DPH** — porovná zaúčtovaný obrat účtu **343** s daní
  ...
  34](39_Vykazy_DPH.md)); dává smysl jen když je zvolený rozsah přesně jeden kalendářní
...
- **DUZP proti příloze** (varování) — doklady, u kterých AI vyčetla z přílohy DUZP
  ...
  v kapitole [Připojení skenů k dokladům](33_Pripojeni_skenu.md#rozpory-dokladu-s-prilohami).
...
**Zámek k datu.** Nahoře na stránce vidíš aktuální stav [zámku účtování k datu](48_Ucetni_denik.md#489-zamek-uctovani-k-datu)
...
### 91.7.1 Kontrolní mapa K1–K10 a její interpretace
