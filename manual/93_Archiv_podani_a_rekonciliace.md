# 93. EPO podání, archív a daňová rekonciliace
...
Související výpočty jsou popsány v kapitolách [Výkazy DPH](39_Vykazy_DPH.md),
[Souhrnné hlášení](42_Souhrnne_hlaseni.md) a [Daň z příjmů](41_Dan_z_prijmu.md).

## 93.1 Stavy daňového výstupu
...
### 93.1.1 Filtr, hledání a stránkování
...
### 93.1.2 Kdy jde snapshot smazat
...
## 93.3 Přímé podání přes EPO API
...
### 93.3.1 Jak získat vhodný certifikát
...
### 93.3.2 Zkušební prostředí pro vývoj
...
## 93.4 Asistované podání přes EPO
...
[Měsíční kontrolu](91_Uzaverka.md#917-mesicni-kontrola), pokud to již neprovedlo
řízené workflow firmy.

## 93.5 Rekonciliace proti skutečně podanému XML
...
a evidence popisuje kapitola [43. Režim OSS](43_OSS.md#439-priznani-a-podani).

### 93.5.3 DPH, KH, DPFO a pojistné
...
## 93.6 Řádné, opravné a dodatečné podání
