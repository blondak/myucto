...
Globální registraci odesílací brány spravuje provozovatel systému v kapitole [Odesílací brána ISDS](98_Odesilaci_brana_ISDS.md). Firma její certifikát ani tajné údaje nevidí.
...
## 97.2 Přístup pro ruční načtení doručené pošty

### 97.2.1 Mobilní klíč eGovernmentu
...
### 97.2.2 Uživatelské jméno a heslo
...
### 97.2.3 Uživatelské jméno, heslo a SMS kód
...
### 97.2.4 Systémový certifikát firmy
...
## 97.3 Ruční načtení příchozích zpráv
...
### 97.4.1 Odeslání přes bránu ISDS
...
### 97.4.2 Odeslání přímo z aplikace v relaci Mobilního klíče
...
### 97.4.4 Zrušení a smazání odchozí zprávy
...
### 97.4.5 Listování a filtr podle měsíce
