...
Globální registraci odesílací brány spravuje provozovatel systému v kapitole [Odesílací brána ISDS](99_Odesilaci_brana_ISDS.md). Firma její certifikát ani tajné údaje nevidí.
...
## 98.2 Přístup pro ruční načtení doručené pošty

### 98.2.1 Mobilní klíč eGovernmentu
...
### 98.2.2 Uživatelské jméno a heslo
...
### 98.2.3 Uživatelské jméno, heslo a SMS kód
...
### 98.2.4 Systémový certifikát firmy
...
## 98.3 Ruční načtení příchozích zpráv
...
### 98.4.1 Odeslání přes bránu ISDS
...
### 98.4.2 Odeslání přímo z aplikace v relaci Mobilního klíče
...
### 98.4.4 Zrušení a smazání odchozí zprávy
...
### 98.4.5 Listování a filtr podle měsíce
...
## 98.6 Související kapitoly

- [Odesílací brána ISDS](99_Odesilaci_brana_ISDS.md) — globální registrace a provoz brány,
- [Podání a hlášení](71_Podani_a_hlaseni.md) — mzdové formuláře, jejich stavy a opravy,
