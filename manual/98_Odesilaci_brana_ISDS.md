...
## 98.3 Uložení, ověření a aktivace
...
Ruční načtení doručených zpráv, firemní přístupy a náhradní ruční odeslání popisuje kapitola [Datová schránka](97_Datova_schranka.md). Mzdové formuláře a jejich věcný stav popisuje kapitola [Podání a hlášení](85_Podani_a_hlaseni.md).
