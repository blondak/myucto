...
Docker příkazů je v [§ 102.2.4](101_Bezpecnost.md#10124-obnova-pristupu). Neupravuj
...
[§ 102.2.1](101_Bezpecnost.md#provozni-diagnostika-canonical-appurl).
...
1. Vygeneruj klíče: viz [§ 102.8](101_Bezpecnost.md#1018-dkim-podpis-e-mailu).
...
Před exportem nastav v **Systém → Firmy → [tvoje firma] → záložka Pohoda**:
...
v kapitolách [Mzdové běhy](80_Mzdove_behy.md) a
