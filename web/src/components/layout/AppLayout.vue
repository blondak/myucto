...
const MANUAL_CHAPTERS: Array<[RegExp, string]> = [
  ...
  [/^\/reports\/submissions(?:\/|$)/, '68_Archiv_podani_a_rekonciliace'],
  ...
  [/^\/accounting\/offsets(?:\/|$)/, '61_Zapocty'],
  [/^\/admin\/accounting-activation(?:\/|$)/, '62_Aktivace_ucetnictvi'],
  [/^\/accounting\/balance-inventory(?:\/|$)/, '63_Inventarizace_rozvahovych_uctu'],
  [/^\/accounting\/section18-statements(?:\/|$)/, '64_Vykazy_podle_paragrafu_18'],
  [/^\/reports\/related-parties(?:\/|$)/, '65_Propojene_osoby'],
  [/^\/accounting\/periods(?:\/|$)/, '66_Uzaverka'],
  [/^\/accounting\/journal(?:\/|$)/, '44_Ucetni_denik'],
  [/^\/accounting(?:\/|$)|^\/utilities(?:\/|$)/, '67_Ucetni_nastroje'],
  [/^\/tax-evidence(?:\/|$)/, '69_Danova_evidence'],
  [/^\/admin\/suppliers(?:\/|$)/, '70_Multi_supplier'],
  [/^\/admin\/electronic-signatures(?:\/|$)/, '72_Elektronicke_podpisy'],
