...
const MANUAL_CHAPTERS: Array<[RegExp, string]> = [
  ...
  [/^\/reports\/submissions(?:\/|$)/, '69_Archiv_podani_a_rekonciliace'],
  [/^\/reports\/monthly-export(?:\/|$)/, '41_Hromadny_export'],
  [/^\/reports\/(?:dph|kh|s74b|vat-corrections)(?:\/|$)/, '36_Vykazy_DPH'],
  [/^\/tax(?:\/|$)/, '40_Danovy_optimalizator'],
  [/^\/portfolio(?:\/|$)/, '43_Prehled_firem'],
  [/^\/automation(?:\/|$)/, '45_Automat'],
  [/^\/accounting\/manual-posting-queue(?:\/|$)/, '46_Rucni_fronta_doctovani'],
  [/^\/accounting\/general-ledger(?:\/|$)/, '47_Hlavni_kniha'],
  [/^\/accounting\/trial-balance(?:\/|$)/, '48_Obratova_predvaha'],
  [/^\/accounting\/balance-sheet(?:\/|$)/, '49_Rozvaha'],
  [/^\/accounting\/income-statement-by-function(?:\/|$)/, '51_Vysledovka_ucelova'],
  [/^\/accounting\/income-statement(?:\/|$)/, '50_Vysledovka_druhova'],
  [/^\/accounting\/saldo(?:\/|$)/, '52_Saldokonto'],
  ...
  [/^\/payroll\/absences(?:\/|$)/, '57_Uplne_mzdy'],
  [/^\/payroll\/quick-inputs(?:\/|$)/, '57_Uplne_mzdy'],
  [/^\/payroll\/components(?:\/|$)/, '57_Uplne_mzdy'],
  [/^\/payroll\/enforcement(?:\/|$)/, '57_Uplne_mzdy'],
  [/^\/payroll\/documents(?:\/|$)/, '57_Uplne_mzdy'],
  [/^\/payroll(?:\/|$)/, '57_Uplne_mzdy'],
  [/^\/accounting\/payroll(?:\/|$)/, '56_Mzdy'],
  [/^\/accounting\/assets(?:\/|$)|^\/accounting\/small-assets(?:\/|$)/, '58_Majetek'],
  [/^\/accounting\/accounts(?:\/|$)/, '61_Ucetni_osnova'],
  [/^\/accounting\/offsets(?:\/|$)/, '62_Zapocty'],
  [/^\/admin\/accounting-activation(?:\/|$)/, '63_Aktivace_ucetnictvi'],
  [/^\/accounting\/balance-inventory(?:\/|$)/, '64_Inventarizace_rozvahovych_uctu'],
  [/^\/accounting\/section18-statements(?:\/|$)/, '65_Vykazy_podle_paragrafu_18'],
  [/^\/reports\/related-parties(?:\/|$)/, '66_Propojene_osoby'],
  [/^\/accounting\/periods(?:\/|$)/, '67_Uzaverka'],
  [/^\/accounting\/journal(?:\/|$)/, '44_Ucetni_denik'],
  [/^\/accounting(?:\/|$)|^\/utilities(?:\/|$)/, '68_Ucetni_nastroje'],
  [/^\/tax-evidence(?:\/|$)/, '70_Danova_evidence'],
  [/^\/admin\/suppliers(?:\/|$)/, '71_Multi_supplier'],
  [/^\/admin\/electronic-signatures(?:\/|$)/, '73_Elektronicke_podpisy'],
  [/^\/admin\/tax-constants(?:\/|$)/, '74_Danove_konstanty'],
  [/^\/admin\/(?:users|roles|activity-log|cron-jobs)(?:\/|$)/, '75_Bezpecnost'],
  [/^\/admin\/update(?:\/|$)/, '76_Aktualizace'],
  [/^\/profile\/mcp-server(?:\/|$)/, '79_MCP_server'],
  [/^\/profile\/api-tokens(?:\/|$)/, '77_API'],
  [/^\/activation(?:\/|$)/, '78_Licence_a_aktivace'],
  [/^\/admin(?:\/|$)/, '72_Nastaveni'],
  [/^\/profile(?:\/|$)/, '75_Bezpecnost'],
