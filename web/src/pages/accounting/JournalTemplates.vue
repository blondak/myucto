...
<template>
  <div>
    ...
    <div v-else-if="templates.length === 0" class="bg-surface border border-neutral-200 rounded-lg p-8 text-center text-sm text-neutral-500">
      {{ t('accounting.manual.template.empty') }}
    </div>
