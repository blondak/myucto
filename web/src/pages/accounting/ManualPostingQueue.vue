...
<template>
  <div>
    ...
    -->
    <EmptyState v-else-if="items.length === 0" boxed accent="success" icon="checkCircle"
      :title="t('manualQueue.empty')" :message="t('manualQueue.empty_hint')"
      :cta="t('manualQueue.empty_cta_bank')" cta-icon="checkCircle" cta-variant="success" to="/bank?tab=posting"
      :secondary="t('manualQueue.empty_cta_automation')" secondary-to="/automation" secondary-icon="cycle" />
