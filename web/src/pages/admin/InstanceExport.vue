...
<template>
  <div>
    ...
    <section class="bg-surface border border-neutral-200 rounded-lg shadow-sm p-4 mb-4 text-sm text-neutral-700">
      ...
      <code class="block mt-2 rounded bg-neutral-900 text-neutral-100 px-3 py-2 text-xs break-all">php api/bin/archive-restore.php --file=export.zip --database=prazdna_migrovana_db --restore --storage=cesta-k-novym-datum --documents</code>
