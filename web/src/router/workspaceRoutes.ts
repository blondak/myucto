...
export function createWorkspaceRoutes(): RouteRecordRaw[] {
  return [
      ...
      {
        path: 'imports/money-s3', name: 'imports-money-s3',
        component: () => import('@/pages/imports/MoneyS3Migration.vue'), meta: { requiresSupplier: true },
        beforeEnter: () => {
          const auth = useAuthStore()
      ...
      // Peníze → Platební karty: evidence karet (jen koncovka) + platby kartou bez dokladu.
